...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(8)("1483402c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-eb369494\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddInvoiceReturnMaterialReceipt.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-eb369494\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddInvoiceReturnMaterialReceipt.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            newRMR: {
                ...
                return_date: null,
                return_notes: null,
                return_total_amount: null,
                return_tax_amount: null,
                return_discounted_amount: null,
                return_discount_percentage: null,
                return_credit_balance: null,
    ...
    computed: {
        ...
        taxTotal: function taxTotal() {
            ...
            // this.newRMR.return_tax_amount = taxAmount
        ...
        grandTotal: function grandTotal() {
            ...
            this.newRMR.return_credit_balance = this.newRMR.return_total_amount;
        ...
        totalContactDiscountedAmount: function totalContactDiscountedAmount() {
            ...
            this.newRMR.return_discounted_amount = total;
        ...
        getDiscountValues: function getDiscountValues() {
            ...
            vm.newRMR.reuturn_discount_percentage = totalDiscount;
        }
    },
    ...
    methods: {
        ...
        fetchItemWithPurchasePrice: function fetchItemWithPurchasePrice() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=purchase').then(function (response) {
                ...
                console.log(response.statusText);
                _this2.$set(_this2, 'itemsWithPurchasePrice', response.data);
            });
        },
        addReturnMaterialReceipt: function addReturnMaterialReceipt() {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/return-material-receipts/create', this.newRMR).then(function (response) {
                ...
                return _this3.addReturnMaterialReceiptItems(response.data);
        ...
        addReturnMaterialReceiptItems: function addReturnMaterialReceiptItems(data) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/return-material-receipt-items/create', { rows: this.rows }).then(function (response) {

                console.log(response.data);
                return _this4.recordTransactionDiscounts(response.data);
            }, function (response) {
                this.errors = response.data;
                console.log(response.data);
                this.formIsSubmitted = false;
        ...
        recordTransactionDiscounts: function recordTransactionDiscounts(data) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/create', { contact_discounts: rmrTransactionDiscounts, bad_stocks_whouse_id: this.newRMR.bad_stocks_whouse_id, new_rmr: this.newRMR, rows: this.rows }).then(function (response) {

                console.log(response.data);
                _this5.loading = false;
                return _this5.createCustomerPayableJournal(rmrTransactionDiscounts);
        ...
        fetchTransactionDiscounts: function fetchTransactionDiscounts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/SOID-' + this.invoice.inv_order_no).then(function (response) {
                ...
                _this6.$set(_this6, 'transactionDiscounts', response.data);

                console.log(response);

                _this6.transactionDiscountsIsLoaded = true;
            }, function (response) {
        ...
        fetchInvoice: function fetchInvoice(invoiceId) {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoices/' + invoiceId).then(function (response) {
                _this8.$set(_this8, 'items', response.data.items);
                _this8.$set(_this8, 'invoice', response.data.invoice);
                _this8.prepareRows(response.data.items);
                _this8.fetchTransactionDiscounts();
                _this8.newRMR.contact_id = _this8.invoice.contact_id;
                _this8.newRMR.whouse_id = _this8.invoice.whouse_id;
            });
        },
        prepareRows: function prepareRows(items) {
            ...
            for (var x = 0; x < items.length; x++) {
                var item = {
                    ...
                    item_desc: items[x].item_name + '-' + items[x].item_desc,
        ...
        fetchContacts: function fetchContacts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/contacts').then(function (response) {
                _this10.$set(_this10, 'contacts', response.data);
        ...
        fetchAccounts: function fetchAccounts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/accounts').then(function (response) {
                _this11.$set(_this11, 'accounts', response.data);
                _this11.stopLoadingPlease();
            }, function (response) {
                _this11.error = response.status;
                _this11.stopLoadingPlease();
            });
        },
        createCustomerPayableJournal: function createCustomerPayableJournal() {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', { journal: journal, contact_discounts: rmrTransactionDiscounts, bad_stocks_whouse_id: this.newRMR.bad_stocks_whouse_id, rmr_id: data.rmr_id, new_rmr: this.newRMR, rows: this.rows }).then(function (response) {
                ...
                return _this12.createCustomerPayableJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createInventoryJournal: function createInventoryJournal() {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                // alert('Journal has been created !')
                // this.$router.push({path : '/invoices' })
                return _this13.createInventoryJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
    ...
    _c("div", { staticClass: "page-title" }, [
      _c(
        ...
        [
          _c(
            "router-link",
            { staticClass: "text-link", attrs: { to: "/invoices" } },
            [
              _c(
                "button",
      ...
      !_vm.loading
        ? _c("div", { staticClass: "title" }, [
            _vm._v(" " + _vm._s(_vm.invoice.inv_no) + " > Returns Issuance ")
          ])
        : _vm._e()
    ]),
    _vm._v(" "),
    ...
    _c("form", { staticClass: "form-horizontal", attrs: { role: "form" } }, [
      _c("div", { staticClass: "form-content" }, [
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("div", { staticClass: "col-md-4" }, [
              _c("input", {
                ...
                domProps: { value: _vm.newRMR.return_ref_no },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.newRMR, "return_ref_no", $event.target.value)
                  }
                }
              })
            ])
                ...
                _c("div", { staticClass: "col-md-4" }, [
                  _c(
                    ...
                    [
                      _c(
                        "option",
                        { domProps: { value: _vm.newRMR.contact_id } },
                        [
                          _vm._v(
                            " " +
                              _vm._s(_vm.items[0].contact_company_name) +
                              " "
                          )
                        ]
                      )
            ...
            _c("div", { staticClass: "col-md-5" }, [
              _c(
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.newRMR.sales_person_id,
                      expression: "newRMR.sales_person_id"
                    }
                  ],
                  staticClass: "form-control",
                ...
                _vm._l(_vm.salespersons, function(salesperson) {
                  return _c(
                    "option",
                    { domProps: { value: salesperson.sales_person_id } },
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("div", { staticClass: "col-md-4" }, [
              _c("input", {
                ...
                domProps: { value: _vm.newRMR.return_date },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.newRMR, "return_date", $event.target.value)
                  }
                }
              })
            ])
        ...
        _c("div", { staticClass: "plain" }, [
          _c("p", [
            _vm._v(
              "We rolled out refunds for customers per invoice. Please choose the account where we will deduct funds from"
            )
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "form-group" }, [
        ...
        _vm._v(" "),
        !_vm.transactionDiscountsIsLoaded
                ...
                _c(
                  ...
                  [
                      ...
                      return _c("tr", { key: row }, [
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("p", {
                              domProps: { innerHTML: _vm._s(row.item_name) }
                            }),
                            _vm._v(" "),
                            _c("p", {
                        ...
                        _c("td", { attrs: { width: "10%" } }, [
                          _c("input", {
                            ...
                            domProps: { value: row.return_qty },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                                }
                                _vm.$set(row, "return_qty", $event.target.value)
                              }
                            }
                          })
                        ]),
                        ...
                        _c("td", [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _c("option", { attrs: { value: "Bad Stocks" } }, [
                                _vm._v(
                                  "\n                                       Bad Stocks\n                                    "
                                )
                              ])
                        ...
                        _c("td", [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _c("option", { attrs: { value: "Rat Bite" } }, [
                                _vm._v("Rat Bite")
                              ]),
                              _vm._v(" "),
                              _c("option", { attrs: { value: "Loose Pack" } }, [
                                _vm._v("Loose Pack")
                              ]),
                              _vm._v(" "),
                              _c("option", { attrs: { value: "Broken Jar" } }, [
                                _vm._v("Broken Jar")
                              ]),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "Moistened/Melted" } },
                                [_vm._v("Moistened/Melted")]
                              ),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "Deformed/Hardened" } },
                                [_vm._v("Deformed/Hardened")]
                              ),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "NTE/Expired" } },
                                [_vm._v("NTE/Expired")]
                              ),
                              _vm._v(" "),
                              _c("option", { attrs: { value: "Dented" } }, [
                                _vm._v("Dented")
                              ]),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "Contaminated" } },
                                [_vm._v("Contaminated")]
                              ),
                              _vm._v(" "),
                              _c("option", { attrs: { value: "Rusty Can" } }, [
                                _vm._v("Rusty Can")
                              ]),
                              _vm._v(" "),
                              _c(
                              ...
                              _c(
                                "option",
                                { attrs: { value: "Bloated/Busted" } },
                                [_vm._v("Bloated/Busted")]
                              ),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "Label Issue" } },
                                [_vm._v("Label Issue")]
                              ),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "Loose/Bursted Pack" } },
                                [_vm._v("Loose/Bursted Pack")]
                              ),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "Weevils/Insects" } },
                                [_vm._v("Weevils/Insects")]
                              ),
                              _vm._v(" "),
                              _c(
                                "option",
                                { attrs: { value: "Broken Canister" } },
                                [_vm._v("Broken Canister")]
                              )
                            ]
                          )
                        ]),
                        ...
                        _c("td", [
                          _c("input", {
                            ...
                            staticClass: "form-control",
                            attrs: { type: "number" },
                            domProps: { value: row.return_price },
                            on: {
                              input: function($event) {
                                if ($event.target.composing) {
                                  return
                        ...
                        _c("td", [
                          _vm._v(
                            "\n                                " +
                              _vm._s(
                                Number(
                                  row.return_price * row.return_qty
                                ).toFixed(2)
                              ) +
                              "\n                            "
                          )
                    ...
                    _c("tr", [
                      ...
                      _vm._v(" "),
                      _c("td", [
                        _c("strong", [_vm._v(" " + _vm._s(_vm.taxTotal) + " ")])
                      ])
                    ]),
                    _vm._v(" "),
                          ...
                          [
                            _vm._v(
                              "\n                                " +
                                ...
                                _vm._s(
                                  Number(
                                    discount.tran_discount_percentage
                                  ).toFixed(0)
                                ) +
                                "%)\n                            "
                            )
                      ...
                      _c("td", [
                        _c("strong", [
                          _vm._v(
                            " " +
                              _vm._s(
                                Number(_vm.total * 0.89285714285).toFixed(2)
                              ) +
                              " "
                          )
                        ])
                ...
                [
                  ...
                  _c("div", { staticClass: "col-md-5" }, [
                    _c("textarea", {
                      ...
                      staticClass: "form-control",
                      attrs: { rows: "2" },
                      domProps: { value: _vm.newRMR.return_notes },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
            ...
            [
              ...
              _c(
                "router-link",
                {
                  ...
                  attrs: { to: "/invoices/" + _vm.invoiceId }
                },
                [
                  _c(
                    "button",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-eb369494", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Invoices\\AddInvoiceReturnMaterialReceipt.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-eb369494", Component.options)
  } else {
    hotAPI.reload("data-v-eb369494", Component.options)
  }
