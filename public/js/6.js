...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v("\n             Back to Stock Adjustments")])])], 1), _vm._v(" "), _c('div', {
    staticClass: "title"
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newStockAdjustment.stock_adjustment_ref_no = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    on: {
      "change": [function($event) {
        ...
        _vm.newStockAdjustment.whouse_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }, function($event) {
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Adjustment Date")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newStockAdjustment.stock_adjustment_date = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('p', {
    staticClass: "required-field"
  }, [_vm._v("Please select your adjustment reason : ")]), _vm._v(" "), _c('div', {
    staticClass: "radio"
  }, [_c('label', [_c('input', {
    directives: [{
      name: "model",
    ...
    domProps: {
      "checked": _vm._q(_vm.adjustmentReason, "physical_count_is_less_than_system_count")
    },
    on: {
      "__c": function($event) {
        _vm.adjustmentReason = "physical_count_is_less_than_system_count"
      }
    }
  }), _vm._v(" "), _c('strong', [_vm._v(" Physical inventory count is less than to the system's count ")]), _vm._v(" "), _c('p', {
    staticStyle: {
      "font-size": "13px",
      "color": "#757474"
    }
  }, [_vm._v(" System will compose a ledger and will create a debit entry to your Cost of Goods Sold account and credit entry to your Merchandise Inventory account.")])])]), _vm._v(" "), _c('div', {
    staticClass: "radio"
  }, [_c('label', [_c('input', {
    directives: [{
      name: "model",
    ...
    domProps: {
      "checked": _vm._q(_vm.adjustmentReason, "physical_count_is_greater_than_system_count")
    },
    on: {
      "__c": function($event) {
        _vm.adjustmentReason = "physical_count_is_greater_than_system_count"
      }
    }
  }), _vm._v(" "), _c('strong', [_vm._v(" Physical inventory count is greater than to the system's count ")]), _vm._v(" "), _c('p', {
    staticStyle: {
      "font-size": "13px",
      "color": "#757474"
    }
  }, [_vm._v(" System will compose a ledger and will create a debit entry to your Merchandise Inventory account and credit entry to your Cost of Goods Sold account.")])])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
  }, [_c('table', {
    ...
    return _c('tr', {
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          row.adjusted_qty = $event.target.value
        },
        "blur": function($event) {
          _vm.$forceUpdate()
        }
      }
    })]), _vm._v(" "), _c('td', [_vm._v("\n                                " + _vm._s(parseFloat(row.adjusted_qty) * parseFloat(row.purchase_price)) + "\n                            ")]), _vm._v(" "), _c('td', [_c('a', {
      on: {
  ...
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _vm._m(3), _vm._v(" "), _c('td', [_vm._v("\n                                " + _vm._s(_vm.totalAdjustedAmount) + "\n                            ")])])], 2)]), _vm._v(" "), _c('a', {
    staticClass: "btn btn-default",
    on: {
      "click": function($event) {
        _vm.addRow()
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newStockAdjustment.stock_adjustment_notes = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  ...
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Item & Desc")]), _vm._v(" "), _c('th', [_vm._v("Purchase Price")]), _vm._v(" "), _c('th', [_vm._v("Adjusted Quantity")]), _vm._v(" "), _c('th', [_vm._v("Amount")]), _vm._v(" "), _c('th')])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
