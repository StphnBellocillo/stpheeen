...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Settings\\Warehouses.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Warehouses.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d896faf", Component.options)
  } else {
    hotAPI.reload("data-v-7d896faf", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("Warehouses")]), _c('hr'), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.loading),
  ...
  }, [_vm._v(" Preparing data... ")])]), _vm._v(" "), _vm._l((_vm.warehouses), function(warehouse) {
    return _c('div', {
      ...
      staticClass: "wpanel-title panel-title"
    }, [_vm._v(" " + _vm._s(warehouse.whouse_name) + " [ " + _vm._s(warehouse.whouse_status) + " ] ")])]), _vm._v(" "), _c('div', {
    ...
    }, [_vm._v("Make as Primary")]), _vm._v(" "), _c('a', {
      staticClass: "dropdown-item",
      attrs: {
        "data-toggle": "modal",
        "href": "#modalReceiveAll"
    ...
    }, [_vm._v("Mark as Inactive")]), _vm._v(" "), _c('a', {
      staticClass: "dropdown-item",
      attrs: {
        "data-toggle": "modal"
      },
      ...
      staticClass: "panel-body wpanel-body"
    }, [(warehouse.whouse_status == 'Primary') ? _c('span', {
      staticClass: "pull-right"
    }, [_vm._m(2, true)]) : _vm._e(), _vm._v(" "), _c('strong', [_vm._v(" Address ")]), _vm._v(" "), _c('br'), _vm._v(" "), _c('p', [_vm._v("City     : " + _vm._s(warehouse.whouse_city) + " ")]), _vm._v(" "), _c('p', [_vm._v("Country  : " + _vm._s(warehouse.whouse_country) + " ")]), _vm._v(" "), _c('p', [_vm._v("Zip Code : " + _vm._s(warehouse.whouse_zip) + " ")]), _vm._v(" "), _c('p', [_vm._v("Phone    : " + _vm._s(warehouse.whouse_tel_num) + " ")])])])])
  }), _vm._v(" "), _c('div', {
    staticClass: "modal fade",
    attrs: {
      "id": "modal-new-warehouse"
    }
  }, [_c('div', {
  ...
  }, [_vm._v("New Warehouse")]) : _vm._e(), _vm._v(" "), (_vm.edit) ? _c('h4', {
    staticClass: "modal-title"
  }, [_vm._v("Edit Warehouse")]) : _vm._e(), _vm._v(" "), (_vm.loading) ? _c('div', {
    attrs: {
      "align": "center"
    }
  }, [_vm._v(" Loading data...")]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "modal-body"
  }, [(_vm.error) ? _c('div', [_vm._v("\n                        " + _vm._s(_vm.error) + "\n                    ")]) : _vm._e(), _vm._v(" "), (!_vm.loading && !_vm.error) ? _c('form', {
  ...
  }, [_vm._v("Warehouse Name")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-6"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newWarehouse.whouse_name = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newWarehouse.whouse_city = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newWarehouse.whouse_country = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newWarehouse.whouse_zip = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newWarehouse.whouse_tel_num = $event.target.value
      }
    }
  ...
  return _c('span', {
    ...
    attrs: {
      "title": "Currently set as primary warehouse"
    }
  }, [_c('i', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7d896faf", module.exports)
  }
}
