...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        totalInvoiceAmount: function totalInvoiceAmount() {
            var total = 0.00;
            if (this.transactionInvoices != null) {

                this.transactionInvoices.forEach(function (transaction) {
                    return total += parseFloat(transaction.inv_total_amount);
                });
            }
            return total;
        },
        totalSalesOrderAmount: function totalSalesOrderAmount() {
            var total = 0.00;
            if (this.transactionSalesOrders != null) {
                this.transactionSalesOrders.forEach(function (transaction) {
                    return total += parseFloat(transaction.so_total_amount);
                });
            }
            return total;
        },
        totalSKUValue: function totalSKUValue() {
            var totalValue = 0;
            this.transactionPerSkus.forEach(function (sku) {
                return totalValue += sku.total_qty * sku.inv_item_rate;
            });
            return totalValue;
        }
    },
    ...
    data: function data() {
        return {
            ...
            // vue-instant 
            inputSKU: '',
            suggestionAttribute: 'display_name',
            suggestions: [],

            transactionInvoices: [],
            transactionSalesOrders: [],
            transactionPerSkus: [],
            salespersons: [],
    ...
    methods: {
        fetchTransactions: function fetchTransactions(index) {
            ...
            //find the index
            var queryResult = linq.from(this.salespersons).where(function (salesperson) {
                return salesperson.display_name == vm.salesperson_name;
            }).toArray();

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/reports/generate/per-salesperson?salesperson_id=' + queryResult[0].sales_person_id + '&start_date=' + this.date_from + '&end_date=' + this.date_to).then(function (response) {
                console.log(response.statusText);
                _this.$set(_this, 'transactionInvoices', response.data.invoices);
                _this.$set(_this, 'transactionSalesOrders', response.data.salesorders);
                _this.$set(_this, 'transactionPerSkus', response.data.report_per_skus);
                _this.loading = false;
            });
        },
        ...
        changed: function changed() {
            ...
            this.salespersons.forEach(function (salesperson) {
                vm.suggestions.push(salesperson);
            });
        },
        ...
        fetchSalesPersons: function fetchSalesPersons() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/salespersons').then(function (response) {
                console.log(response.statusText);
                _this2.$set(_this2, 'salespersons', response.data);
            });
        }
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("\n                Select Salesperson : "), _c('vue-instant', {
    attrs: {
      ...
      "name": "customName",
      "placeholder": "Search by sales person name and hit enter",
      "type": "google"
    },
    on: {
    ...
    model: {
      value: (_vm.salesperson_name),
      callback: function($$v) {
        _vm.salesperson_name = $$v
      },
      expression: "salesperson_name"
    }
  })], 1), _vm._v(" "), _c('div', {
    staticClass: "col-md-4"
  }, [_vm._v("\n                From\n                "), _c('input', {
  ...
  })])]), _vm._v(" "), _c('h3', [_vm._v("Transactions")]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v(" Fetching data... This may take a while ")])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.loading),
  ...
  }, [_vm._m(1), _vm._v(" "), _c('tbody', [(_vm.loading) ? _c('div', {
    staticStyle: {
      "margin-top": "20px",
      "margin-left": "150"
    },
  ...
  })]) : _vm._e(), _vm._v(" "), _vm._l((_vm.transactionSalesOrders), function(transaction) {
    return (_vm.transactionSalesOrders.length != 0) ? _c('tr', [_c('td', [_vm._v(" " + _vm._s(transaction.so_no) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.contact_company_name) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.so_order_date) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.so_status) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(transaction.so_total_amount, 'PHP', 2)) + " ")])]) : _vm._e()
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', [_vm._v("\n                                Grand Total\n                            ")]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.totalSalesOrderAmount, 'PHP', 2)) + " ")])])])], 2)])])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.loading),
    ...
    staticClass: "table table-hover"
  }, [_vm._m(2), _vm._v(" "), _c('tbody', [(_vm.loading) ? _c('div', {
    staticStyle: {
      "margin-top": "20px",
      "margin-left": "150"
    },
    ...
    staticClass: "fa fa-spinner fa-spin fa-2x fa-fw"
  })]) : _vm._e(), _vm._v(" "), _vm._l((_vm.transactionInvoices), function(transaction) {
    return (_vm.transactionInvoices.length != 0) ? _c('tr', [_c('td', [_vm._v(" " + _vm._s(transaction.inv_no) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.contact_company_name) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.inv_date) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.inv_status) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(transaction.inv_balance_amount, 'PHP', 2)) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(transaction.inv_total_amount, 'PHP', 2)) + " ")])]) : _vm._e()
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', [_vm._v("\n                                Grand Total\n                            ")]), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.totalInvoiceAmount, 'PHP', 2)) + " ")])])])], 2)])])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (!_vm.loading),
    ...
    staticClass: "panel-heading"
  }, [_vm._v("\n            ALL SOLD SKU'S PER MONTH\n          ")]), _vm._v(" "), _c('div', {
    staticClass: "panel-body"
  }, [_c('table', {
    staticClass: "table table-hover"
  }, [_vm._m(3), _vm._v(" "), _c('tbody', [(_vm.loading) ? _c('div', {
    staticStyle: {
      "margin-top": "20px",
      "margin-left": "150"
    },
    ...
    staticClass: "fa fa-spinner fa-spin fa-2x fa-fw"
  })]) : _vm._e(), _vm._v(" "), _vm._l((_vm.transactionPerSkus), function(transaction) {
    return (_vm.transactionPerSkus.length != 0) ? _c('tr', [_c('td', [_vm._v(" " + _vm._s(transaction.item_sku) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.item_name) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.month) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(transaction.total_qty) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(transaction.total_qty * transaction.inv_item_rate, '', 2)) + " ")])]) : _vm._e()
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', [_vm._v(" Total Value ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.totalSKUValue, '', 2)) + " ")])])], 2)])])])])])])])
  ...
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("Report By SalesPerson")])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Sales Order# ")]), _vm._v(" "), _c('th', [_vm._v("Customer")]), _vm._v(" "), _c('th', [_vm._v("Date")]), _vm._v(" "), _c('th', [_vm._v("Status")]), _vm._v(" "), _c('th', [_vm._v("TOTAL")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Invoice# ")]), _vm._v(" "), _c('th', [_vm._v("Customer")]), _vm._v(" "), _c('th', [_vm._v("Date")]), _vm._v(" "), _c('th', [_vm._v("Status")]), _vm._v(" "), _c('th', [_vm._v("Balance")]), _vm._v(" "), _c('th', [_vm._v("Total")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("SKU")]), _vm._v(" "), _c('th', [_vm._v("ITEM NAME")]), _vm._v(" "), _c('th', [_vm._v("MONTH")]), _vm._v(" "), _c('th', [_vm._v("TOTAL QTY")]), _vm._v(" "), _c('th', [_vm._v("VALUE")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-18c3015e", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("10ec0324", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-18c3015e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ReportPerSalesPersons.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-18c3015e\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ReportPerSalesPersons.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Reports\\ReportPerSalesPersons.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] ReportPerSalesPersons.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-18c3015e", Component.options)
  } else {
    hotAPI.reload("data-v-18c3015e", Component.options)
  }
})()}
