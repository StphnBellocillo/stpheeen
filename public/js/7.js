...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            newRMR: {
                ...
                return_date: null,
                return_notes: null,
                deduct_from_account_id: 123, //  not a legit account id
                bad_stocks_whouse_id: null,
                return_credit_balance: 0.00,
                return_total_amount: 0.00,
                return_tax_amount: 0.00,
                return_discounted_amount: 0.00,
                return_discount_percentage: 0.00
    ...
    computed: {
        ...
        grandTotal: function grandTotal() {
            ...
            this.return_discounted_amount = this.totalContactDiscountedAmount;
        ...
        getDiscountValues: function getDiscountValues() {
            ...
            vm.newRMR.return_discount_percentage = totalDiscount;
        }
    },
    ...
    methods: {
        ...
        findItemRate: function findItemRate(index) {
            ...
            this.rows[index].return_price = queryResult[0].retail_price;
        ...
        addReturnMaterialReceipt: function addReturnMaterialReceipt() {
            ...
            this.newRMR.return_credit_balance = this.total;
            this.newRMR.return_total_amount = this.total;
            this.newRMR.return_tax_amount = this.taxTotal;
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/return-material-receipts/create', this.newRMR).then(function (response) {
                ...
                return _this.addReturnMaterialReceiptItems(response.data);
        ...
        addReturnMaterialReceiptItems: function addReturnMaterialReceiptItems(data) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/return-material-receipt-items/create', { bad_stocks_whouse_id: this.newRMR.bad_stocks_whouse_id, rows: this.rows, rmr_id: data.rmr_id, new_rmr: this.newRMR }).then(function (response) {
                ...
                return _this2.recordTransactionDiscounts(data.rmr_id);
            }, function (response) {
                this.errors = response.data;
                this.formIsSubmitted = false;
            });
        ...
        recordTransactionDiscounts: function recordTransactionDiscounts(rmrId) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/create', { contact_discounts: rmrTransactionDiscounts }).then(function (response) {
                ...
                return _this3.createCustomerPayableJournal();
        ...
        fetchContactDiscounts: function fetchContactDiscounts() {
            ...
            this.discountValues = [];
            this.loading = true;
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/contacts/' + this.newRMR.contact_id + '/discounts').then(function (response) {

                _this4.$set(_this4, 'contactDiscounts', response.data);
        ...
        fetchItemWithPurchasePrice: function fetchItemWithPurchasePrice() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=purchase').then(function (response) {
                ...
                _this5.$set(_this5, 'itemsWithPurchasePrice', response.data);
            });
        },
        ...
        fetchWarehouses: function fetchWarehouses() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/warehouses').then(function (response) {
                _this7.$set(_this7, 'warehouses', response.data);
                _this7.stopLoadingPlease();
            }, function (response) {
        ...
        fetchContacts: function fetchContacts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/contacts').then(function (response) {
                _this8.$set(_this8, 'contacts', response.data);
        ...
        createCustomerPayableJournal: function createCustomerPayableJournal() {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                return _this9.createCustomerPayableJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createInventoryJournal: function createInventoryJournal() {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                alert('Journal has been created !');
                // this.$router.push({path : '/invoices' })
                return _this10.createInventoryJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        ...
        createCustomerPayableJournalEntries: function createCustomerPayableJournalEntries(journalId) {
            ...
            //             cost_center_id   :       auth.getCorporationId(this)
            //         },
            //         {
            //             acct_id         :       39, // trade payable
            //             journal_id      :       journalId, 
            //             tax_id          :       1, 
            //             contact_id      :       this.newRMR.contact_id, 
            //             entry_debit     :       this.total,
            //             entry_credit    :       0.00,
            //             entry_desc      :       'Trade Payable',
            //              cost_center_id   :       auth.getCorporationId(this)
            //         }
            // ];

            alert("Total discount " + this.totalContactDiscountedAmount);
            alert("Total sales return " + Number(parseFloat(this.subTotal) + parseFloat(this.totalContactDiscountedAmount)).toFixed(2));
            var entries = [{
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" Back to R.M.Rs\n                ")])])], 1), _vm._v(" "), _c('div', {
    staticClass: "title"
  }, [_vm._v(" New Return Material Receipt ")])]), _vm._v(" "), (_vm.error) ? _c('div', {
    ref: "formErrors",
    staticClass: "alert",
    staticStyle: {
      "background": "#f0f0f0"
    ...
    }, [_vm._v(" " + _vm._s(contact.contact_company_name) + " ")])
  }))])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-2 control-label required-field"
  ...
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(3), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm.subTotal) + " ")])])]), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(4), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm.taxTotal) + " ")])])]), _vm._v(" "), _vm._l((_vm.contactDiscounts), function(discount, index) {
    return _c('tr', [_c('td', {
  ...
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(5), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(Number(_vm.total * 0.89285714285).toFixed(2)) + " ")])])]), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(6), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm.grandTotal) + " ")])])])], 2)]), _vm._v(" "), _c('a', {
    staticClass: "btn btn-default",
    on: {
      "click": function($event) {
        _vm.addRow()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-f57960ea", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("142f4374", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-f57960ea\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddReturnMaterialReceipt.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-f57960ea\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddReturnMaterialReceipt.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\ReturnMaterialReceipt\\AddReturnMaterialReceipt.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddReturnMaterialReceipt.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f57960ea", Component.options)
  } else {
    hotAPI.reload("data-v-f57960ea", Component.options)
  }
})()}
