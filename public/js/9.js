...
/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function mounted() {
        ...
        this.fetchContacts();
        this.fetchAccounts();
        this.fetchItemWithPurchasePrice();
        this.fetchInvoice(this.invoiceId);
        this.initializePlugins();
        this.newRMR.inv_id = this.$route.params.invoice_id;
    },
    data: function data() {
        return {
            // vue-instant 
            ...
            contacts: [],
            loading: false,
            transactionDiscountsIsLoaded: false,
            error: null,
            transactionDiscounts: [],
            itemsWithPurchasePrice: [],
            costOfGoodsSoldValue: 0.00,
            discountValues: [],
            accounts: [],
            invoice: null
        };
    ...
    computed: {
        subTotal: function subTotal() {
            ...
            this.rows.forEach(function (row) {
                return subTotal += row.return_price * row.return_qty;
            });
        ...
        grandTotal: function grandTotal() {
            ...
            this.newRMR.return_amount = this.total;
        ...
        getDiscountValues: function getDiscountValues() {
            ...
            this.rows.forEach(function (row) {
                return initialSubtotal += row.return_qty * parseFloat(row.return_price);
            });
            ...
            // vm.newRMR.discount_percentage = totalDiscount
        }
    },

    methods: {
        calculateCostOfGoodsSold: function calculateCostOfGoodsSold() {
            this.costOfGoodsSoldValue = 0.00;
            // get the cost of goods sold by multiplying from its purchase price
            var vm = this;
            var qtyPerCases = 0;
            this.rows.map(function (value, key) {
                var key = key;
                // get the purchase price from the loaded items
                var queryResult = linq.from(vm.itemsWithPurchasePrice).where(function (item) {
                    return item.item_sku == vm.rows[key].item_sku;
                }).toArray();
                console.log("query result from item rate" + JSON.stringify(queryResult));
                // convert the qty to highest UOM and multiply it to its conversion qty
                qtyPerCases = parseFloat(vm.rows[key].return_qty / queryResult[0].conversion_qty);
                console.log(vm.rows[key].return_qty + " / " + queryResult[0].conversion_qty + "Cases");
                console.log(qtyPerCases + " * " + queryResult[0].purchase_price);
                vm.costOfGoodsSoldValue += parseFloat(queryResult[0].purchase_price) * qtyPerCases;
            });
        },
        ...
        findItemRate: function findItemRate(index) {
            ...
            this.rows[index].return_price = queryResult[0].inv_item_rate;
            this.rows[index].return_qty = 1;
            this.rows[index].return_classification = '';
            this.rows[index].return_reason = '';
        ...
        fetchItemWithPurchasePrice: function fetchItemWithPurchasePrice() {
            var _this = this;
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=purchase').then(function (response) {
                ...
                _this.$set(_this, 'itemsWithPurchasePrice', response.data);
            });
        },
        addReturnMaterialReceipt: function addReturnMaterialReceipt() {
            var _this2 = this;

            this.newRMR.corp_id = __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this);
            this.formIsSubmitted = true;
            console.log(this.rows);
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/return-material-receipts/create', this.newRMR).then(function (response) {

                console.log(response.data);
                return _this2.addReturnMaterialReceiptItems(response.data);
        ...
        addReturnMaterialReceiptItems: function addReturnMaterialReceiptItems(data) {
            var _this3 = this;

            this.rows.total_amount = this.subTotal;
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/return-material-receipt-items/create', { bad_stocks_whouse_id: this.newRMR.bad_stocks_whouse_id, rows: this.rows, rmr_id: data.rmr_id, new_rmr: this.newRMR }).then(function (response) {

                console.log(response.data);
                return _this3.recordTransactionDiscounts(data.rmr_id);
            }, function (response) {
                this.errors = response.data;
                console.log(response.data);
                this.formIsSubmitted = false;
        ...
        recordTransactionDiscounts: function recordTransactionDiscounts(rmrId) {
            var _this4 = this;

            // carry the discounts from sales order to rmr
            var rmrTransactionDiscounts = [];
            var vm = this;
            this.transactionDiscounts.map(function (value, key) {
                var discount = {
                    'tran_discount_ref_no': 'RMRID-' + rmrId,
                    'discount_id': value.discount_id,
                    'tran_discount_percentage': value.tran_discount_percentage,
                    'tran_discount_amount': vm.discountValues[key]
                };

                rmrTransactionDiscounts.push(discount);
            });

            console.log("Contact discounts " + JSON.stringify(rmrTransactionDiscounts));

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/create', { contact_discounts: rmrTransactionDiscounts }).then(function (response) {

                console.log(response.data);
                _this4.loading = false;
                return _this4.createCustomerPayableJournal();
                // this.$router.push({path : '/return-material-receipts/'+data.rmr_id })
                // alert('Rmr order has been created !')
            }, function (response) {
        ...
        fetchTransactionDiscounts: function fetchTransactionDiscounts() {
            ...
            // we will fetch the discounts based on the invoice's Sales order
            this.discountValues = [];
            this.transactionDiscountsIsLoaded = false;
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/SOID-' + this.invoice.inv_order_no).then(function (response) {

                _this5.$set(_this5, 'transactionDiscounts', response.data);

                console.log(response);

                _this5.transactionDiscountsIsLoaded = true;
            }, function (response) {
        ...
        fetchItems: function fetchItems() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=sales').then(function (response) {
                ...
                console.log(response.statusText);
                _this6.$set(_this6, 'items', response.data);
            });
        },
        fetchInvoice: function fetchInvoice(invoiceId) {
            var _this7 = this;

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoices/' + invoiceId).then(function (response) {
                _this7.$set(_this7, 'items', response.data.items);
                _this7.$set(_this7, 'invoice', response.data.invoice);
                _this7.prepareRows(response.data.items);
                _this7.fetchTransactionDiscounts();
                _this7.newRMR.contact_id = _this7.invoice.contact_id;
                _this7.newRMR.whouse_id = _this7.invoice.whouse_id;
            });
        },
        prepareRows: function prepareRows(items) {
            this.rows = [];
            for (var x = 0; x < items.length; x++) {
                var item = {
                    item_sku: items[x].item_sku,
                    item_id: items[x].item_id,
                    item_desc: items[x].item_desc,
                    return_price: items[x].inv_item_rate,
                    return_qty: 1,
                    return_classification: '',
                    return_reason: ''
                };
        ...
        fetchWarehouses: function fetchWarehouses() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/warehouses').then(function (response) {
                _this8.$set(_this8, 'warehouses', response.data);
                _this8.stopLoadingPlease();
            }, function (response) {
        ...
        fetchContacts: function fetchContacts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/contacts').then(function (response) {
                _this9.$set(_this9, 'contacts', response.data);
                _this9.stopLoadingPlease();
            }, function (response) {
                _this9.error = response.status;
                _this9.stopLoadingPlease();
            });
        },
        fetchAccounts: function fetchAccounts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/accounts').then(function (response) {
                _this10.$set(_this10, 'accounts', response.data);
                _this10.stopLoadingPlease();
            }, function (response) {
                _this10.error = response.status;
                _this10.stopLoadingPlease();
            });
        },
        createCustomerPayableJournal: function createCustomerPayableJournal() {
            var _this11 = this;

            alert("TOtal from payable journal  " + this.total);
            var journal = {

                'currency_id': 1,
                'journ_date': this.newRMR.return_date,
                'journ_reference_number': this.newRMR.return_ref_no,
                'journ_notes': this.newRMR.return_notes,
                'journ_total_amount': this.total,
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                return _this11.createCustomerPayableJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createInventoryJournal: function createInventoryJournal() {
            var _this12 = this;

            this.calculateCostOfGoodsSold();
            alert("TOtal from inventory journal  " + this.costOfGoodsSoldValue);
            var journal = {
                ...
                'journ_reference_number': this.newRMR.return_ref_no,
                'journ_notes': this.newRMR.return_notes,
                'journ_total_amount': this.costOfGoodsSoldValue,
                'corp_id': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this),
                'encoded_by': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getAuthenticatedUser(this)
            };
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                alert('Journal has been created !');
                // this.$router.push({path : '/invoices' })
                return _this12.createInventoryJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createInventoryJournalEntries: function createInventoryJournalEntries(journalId) {
            var entries = [{
                ...
                tax_id: 1,
                contact_id: this.newRMR.contact_id,
                entry_debit: 0.00,
                entry_credit: this.costOfGoodsSoldValue,
                ...
                tax_id: 1,
                contact_id: this.newRMR.contact_id,
                entry_debit: this.costOfGoodsSoldValue,
                entry_credit: 0.00,
                entry_desc: 'Merchandise Inventory',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }];
            this.storeEntries(entries, journalId);
            alert("RMR has been created !");
            this.$router.push({ path: '/return-material-receipts' });
        },
        createCustomerPayableJournalEntries: function createCustomerPayableJournalEntries(journalId) {

            var entries = [{
                acct_id: 13, // sales return id
                journal_id: journalId,
                tax_id: 1,
                contact_id: this.newRMR.contact_id,
                entry_debit: Number(parseFloat(this.total) - parseFloat(this.taxTotal)).toFixed(2),
                entry_credit: 0.00,
                entry_desc: 'Sales Returns',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }, {
                acct_id: 100, // output tax
                journal_id: journalId,
                tax_id: 1,
                contact_id: this.newRMR.contact_id,
                entry_debit: this.taxTotal,
                entry_credit: 0.00,
                entry_desc: 'Output Tax',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }, {
                acct_id: 24, // acccounts receivable
                journal_id: journalId,
                tax_id: 1,
                contact_id: this.newRMR.contact_id,
                entry_debit: 0.00,
                entry_credit: this.total,
                entry_desc: 'Accounts Receivable',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }];

            this.storeEntries(entries, journalId);
            this.createInventoryJournal();
        },
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Invoices\\AddInvoiceReturnMaterialReceipt.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddInvoiceReturnMaterialReceipt.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-bdbc3eee", Component.options)
  } else {
    hotAPI.reload("data-v-bdbc3eee", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(" " + _vm._s(_vm.invoice.inv_no) + " > Returns Issuance ")]) : _vm._e()]), _vm._v(" "), (_vm.error) ? _c('div', {
    ref: "formErrors",
    staticClass: "alert",
    staticStyle: {
      "background": "#f0f0f0"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newRMR.return_ref_no),
      expression: "newRMR.return_ref_no"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newRMR.return_ref_no = $event.target.value
      }
    }
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Client Name")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-4"
  }, [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newRMR.contact_id),
      expression: "newRMR.contact_id"
    }],
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newRMR.contact_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    domProps: {
  ...
  }, [_vm._v(" " + _vm._s(_vm.items[0].contact_company_name) + " ")])])])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Return Date")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-4"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newRMR.return_date),
      expression: "newRMR.return_date"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "required": "",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newRMR.return_date = $event.target.value
      }
    }
  })])]), _vm._v(" "), (!_vm.loading) ? _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newRMR.whouse_id),
      expression: "newRMR.whouse_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "100%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newRMR.whouse_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Store Bad Stocks To")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-4"
  }, [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newRMR.bad_stocks_whouse_id),
      expression: "newRMR.bad_stocks_whouse_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "100%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newRMR.bad_stocks_whouse_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, _vm._l((_vm.warehouses), function(warehouse) {
    return _c('option', {
    ...
    staticClass: "plain"
  }, [_c('p', [_vm._v("We rolled out refunds for customers per invoice. Please choose the account where we will deduct funds from")]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-2 control-label required-field "
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newRMR.deduct_from_account_id),
      expression: "newRMR.deduct_from_account_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "49%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newRMR.deduct_from_account_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  ...
  }))])])]), _vm._v(" "), (!_vm.transactionDiscountsIsLoaded) ? _c('p', {
    attrs: {
      "align": "center"
    }
  }, [_c('i', {
    ...
    staticClass: "sr-only"
  }, [_vm._v("Loading...")])]) : _vm._e(), _vm._v(" "), (_vm.transactionDiscountsIsLoaded) ? _c('div', {
    staticClass: "plain"
  }, [_c('table', {
    ...
    return _c('tr', {
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          row.return_qty = $event.target.value
        },
        "blur": function($event) {
          _vm.$forceUpdate()
        }
      ...
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (row.return_classification),
        expression: "row.return_classification"
      }],
      staticClass: "form-control",
      staticStyle: {
      ...
      on: {
        "change": function($event) {
          ...
          row.return_classification = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
        }
      }
    }, [_c('option', {
      attrs: {
      ...
      on: {
        "change": function($event) {
          ...
          row.return_reason = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
        }
      }
    }, [_c('option', {
      attrs: {
    ...
    }, [_vm._v("Good Stocks")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Rat Bite"
      }
    }, [_vm._v("Rat Bite")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Loose Pack"
      }
    }, [_vm._v("Loose Pack")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Broken Jar"
      }
    }, [_vm._v("Broken Jar")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Moistened/Melted"
      }
    }, [_vm._v("Moistened/Melted")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Deformed/Hardened"
      }
    }, [_vm._v("Deformed/Hardened")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "NTE/Expired"
      }
    }, [_vm._v("NTE/Expired")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Dented"
      }
    }, [_vm._v("Dented")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Contaminated"
      }
    }, [_vm._v("Contaminated")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Rusty Can"
      }
    }, [_vm._v("Rusty Can")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Contaminated"
      }
    }, [_vm._v("Contaminated")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Bloated/Busted"
      }
    }, [_vm._v("Bloated/Busted")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Label Issue"
      }
    }, [_vm._v("Label Issue")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Loose/Bursted Pack"
      }
    }, [_vm._v("Loose/Bursted Pack")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Weevils/Insects"
      }
    }, [_vm._v("Weevils/Insects")]), _vm._v(" "), _c('option', {
      attrs: {
        "value": "Broken Canister"
      }
    }, [_vm._v("Broken Canister")])])]), _vm._v(" "), _c('td', [_c('input', {
      directives: [{
        name: "model",
        rawName: "v-model",
        value: (row.return_price),
        expression: "row.return_price"
      }],
      staticClass: "form-control",
      attrs: {
        "type": "number"
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          row.return_price = $event.target.value
        },
        "blur": function($event) {
          _vm.$forceUpdate()
        }
      }
    })]), _vm._v(" "), _c('td', [_vm._v("\n                                " + _vm._s(Number(row.return_price * row.return_qty).toFixed(2)) + "\n                            ")]), _vm._v(" "), _c('td', [_c('a', {
      on: {
  ...
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(3), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm.subTotal) + " ")])])]), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(4), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm.taxTotal) + " ")])])]), _vm._v(" "), _vm._l((_vm.transactionDiscounts), function(discount, index) {
    return _c('tr', [_c('td', {
      staticClass: "text-right",
      attrs: {
        "colspan": "5"
      }
    }, [_vm._v("\n                                " + _vm._s(discount.discount_name) + " (" + _vm._s(Number(discount.tran_discount_percentage).toFixed(0)) + "%)\n                            ")]), _vm._v(" "), _c('td', {
      staticClass: "text-right",
      attrs: {
        "colspan": "2"
      }
    }, [_vm._v("\n                                 " + _vm._s(_vm._f("currency")(_vm.discountValues[index], 'PHP', 2)) + "\n                                " + _vm._s(_vm.getDiscountValues) + "\n                            ")])])
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(5), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(Number(_vm.total * 0.89285714285).toFixed(2)) + " ")])])]), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(6), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm.grandTotal) + " ")])])])], 2)])]) : _vm._e(), _vm._v(" "), (_vm.transactionDiscountsIsLoaded) ? _c('div', {
    staticClass: "stripe"
  }, [_c('div', {
    staticClass: "form-group ",
    staticStyle: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newRMR.return_notes),
      expression: "newRMR.return_notes"
    }],
    staticClass: "form-control",
    attrs: {
      "rows": "2"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newRMR.return_notes = $event.target.value
      }
    }
  })])])]) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "row"
  ...
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Item Details")]), _vm._v(" "), _c('th', [_vm._v("QTY TO RETURN")]), _vm._v(" "), _c('th', [_vm._v("CLASSIFICATION")]), _vm._v(" "), _c('th', [_vm._v("REASON")]), _vm._v(" "), _c('th', [_vm._v("PRICE")]), _vm._v(" "), _c('th', [_vm._v("AMOUNT")]), _vm._v(" "), _c('th')])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('td', {
    attrs: {
      "colspan": "2"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-bdbc3eee", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("24a139c6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-bdbc3eee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddInvoiceReturnMaterialReceipt.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-bdbc3eee\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddInvoiceReturnMaterialReceipt.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
