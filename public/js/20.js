...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        checkIfSKUExist: function checkIfSKUExist() {
            this.SKUAlreadyExist = false;
            var vm = this;
            var queryResult = linq.from(this.items).where(function (item) {
                return item.item_sku == vm.newItem.item_sku;
            }).toArray();
            console.log(JSON.stringify(queryResult));
            if (queryResult.length > 0) {
                this.SKUAlreadyExist = true;
                console.log("SKU already exist !");
                return false;
            }
        },
        showConversion: function showConversion() {

            var vm = this;
            var queryResult = linq.from(this.units).where(function (unit) {
                return unit.unit_id == vm.newItem.unit_id;
            }).toArray();
            if (queryResult[0].conversion_unit != null) {

                return this.unitConversion = 'Available conversion : <br/>' + ' = ' + queryResult[0].conversion_rate + ' ' + queryResult[0].conversion_unit;
            }
            return this.unitConversion = 'No conversion rate found.';
        },
        findUnitName: function findUnitName() {
            var vm = this;
            var queryResultForRetailUnit = linq.from(this.units).where(function (unit) {
                return unit.unit_id == vm.newItemSalesInfo.unit_id;
            }).toArray();
            var queryResultForPurchaseUnit = linq.from(this.units).where(function (unit) {
                return unit.unit_id == vm.newItemPurchaseInfo.unit_id;
            }).toArray();
            if (vm.newItemPurchaseInfo.unit_id == vm.newItemSalesInfo.unit_id) {
                alert("Hey, your retail unit cannot be the same to your purchase unit !");
                return false;
            }
            this.retailUnit = queryResultForRetailUnit[0].unit_name;
            this.purchaseUnit = queryResultForPurchaseUnit[0].unit_name;
        },
        addItem: function addItem() {
            var _this = this;

            if (this.SKUAlreadyExist) {
                if (!confirm("Are you sure you want this item ? This SKU is already exist on the system")) {
                    return false;
                }
            }
            var salesInfoId = null;
            var purchaseInfoId = null;
            var itemId = null;

            this.formIsSubmitted = true;
            this.newItem.corp_id = __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this);

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items/create', this.newItem).then(function (response) {

                _this.storeSalesInfo(response.data);
                _this.storeItemUnits(response.data);
            }, function (response) {
        ...
        updatePurchaseAndSalesInfo: function updatePurchaseAndSalesInfo(itemId, salesInfoId, purchaseInfoId) {
            var _this2 = this;

            // update sales info and purchase info to item
            this.$http.put(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items/' + itemId + '/update-sales-info-and-purchase-info-id', { purchase_info_id: purchaseInfoId, sales_info_id: salesInfoId }).then(function (response) {

                alert('Item has been created !');

                _this2.$router.push({ path: '/items' });
            });
        },
        storeSalesInfo: function storeSalesInfo(data) {
            var _this3 = this;

            this.newItemSalesInfo.item_id = data.item_id;
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items/' + data.item_id + '/add-sales-info', this.newItemSalesInfo).then(function (response) {
                return _this3.storePurchaseInfo(response.data);
            }, function (response) {
        ...
        storePurchaseInfo: function storePurchaseInfo(data) {
            var _this4 = this;

            this.newItemPurchaseInfo.item_id = data.item_id;
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items/' + data.item_id + '/add-purchase-info', this.newItemPurchaseInfo).then(function (response) {
                return _this4.updatePurchaseAndSalesInfo(data.item_id, data.sales_info_id, response.data.purchase_info_id);
            }, function (response) {
        ...
        storeItemUnits: function storeItemUnits(data) {

            var newItemUnit = {
                item_id: data.item_id,
                retail_unit: this.newItemSalesInfo.unit_id,
                purchase_unit: this.newItemPurchaseInfo.unit_id,
                conversion_qty: this.newItem.conversion_qty
            };
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items/' + data.item_id + '/add-item-units', newItemUnit).then(function (response) {}, function (response) {
        ...
        fetchUnits: function fetchUnits() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/units').then(function (response) {
                _this5.$set(_this5, 'units', response.data);
            });
        },
        fetchItems: function fetchItems() {
            var _this6 = this;

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=all').then(function (response) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" Back to Items\n                ")])])], 1), _vm._v(" "), _c('div', {
    staticClass: "title"
  }, [_vm._v("New Item")])]), _vm._v(" "), (_vm.errors.length != 0) ? _c('div', {
    ref: "formErrors",
    staticClass: "alert",
    staticStyle: {
      "background": "#f0f0f0"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.item_name),
      expression: "newItem.item_name"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newItem.item_name = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.item_desc),
      expression: "newItem.item_desc"
    }],
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItem.item_desc = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.item_sku),
      expression: "newItem.item_sku"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      ...
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItem.item_sku = $event.target.value
      }
    }
  }), _vm._v(" "), (_vm.SKUAlreadyExist) ? _c('p', {
    staticClass: "help-block",
    staticStyle: {
      "color": "#FF0000"
    }
  }, [_vm._v(" SKU already exist !   ")]) : _vm._e()])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
  }, [_c('div', {
    staticClass: "row"
  }, [_c('div', {
    staticClass: "col-md-offset-1 col-md-5"
  }, [_c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.item_upc),
      expression: "newItem.item_upc"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItem.item_upc = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-5"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.item_mpn),
      expression: "newItem.item_mpn"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItem.item_mpn = $event.target.value
      }
    }
  })])])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.item_ean),
      expression: "newItem.item_ean"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItem.item_ean = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-5"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.item_isbn),
      expression: "newItem.item_isbn"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItem.item_isbn = $event.target.value
      }
    }
  })])])])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.isSaleable),
      expression: "isSaleable"
    }],
    attrs: {
      "type": "checkbox"
    },
    domProps: {
      "checked": Array.isArray(_vm.isSaleable) ? _vm._i(_vm.isSaleable, null) > -1 : (_vm.isSaleable)
    },
    on: {
      "__c": function($event) {
        var $$a = _vm.isSaleable,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$c) {
            $$i < 0 && (_vm.isSaleable = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.isSaleable = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.isSaleable = $$c
        }
  ...
  }), _vm._v("Sales Information")])]), _c('br'), _vm._v(" "), (_vm.isSaleable) ? _c('span', [_c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Retail Price")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-8"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemSalesInfo.retail_price),
      expression: "newItemSalesInfo.retail_price"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItemSalesInfo.retail_price = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Retail Unit")]), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemSalesInfo.unit_id),
      expression: "newItemSalesInfo.unit_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "50%"
    ...
    on: {
      "change": [function($event) {
        ...
        _vm.newItemSalesInfo.unit_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }, function($event) {
        _vm.findUnitName()
      }]
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemSalesInfo.account_id),
      expression: "newItemSalesInfo.account_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "100%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newItemSalesInfo.account_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
    ...
    staticClass: "col-md-offset-1 col-md-7"
  }, [_c('textarea', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemSalesInfo.description),
      expression: "newItemSalesInfo.description"
    }],
    staticClass: "form-control",
    domProps: {
      "value": (_vm.newItemSalesInfo.description)
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItemSalesInfo.description = $event.target.value
      }
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.isPurchasable),
      expression: "isPurchasable"
    }],
    attrs: {
      "type": "checkbox"
    },
    domProps: {
      "checked": Array.isArray(_vm.isPurchasable) ? _vm._i(_vm.isPurchasable, null) > -1 : (_vm.isPurchasable)
    },
    on: {
      "__c": function($event) {
        var $$a = _vm.isPurchasable,
          $$el = $event.target,
          $$c = $$el.checked ? (true) : (false);
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$c) {
            $$i < 0 && (_vm.isPurchasable = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.isPurchasable = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.isPurchasable = $$c
        }
  ...
  }), _vm._v("Purchase Information")])]), _c('br'), _vm._v(" "), (_vm.isPurchasable) ? _c('span', [_c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Purchase Price")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-6"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemPurchaseInfo.purchase_price),
      expression: "newItemPurchaseInfo.purchase_price"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItemPurchaseInfo.purchase_price = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Purchase Unit")]), _vm._v(" "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemPurchaseInfo.unit_id),
      expression: "newItemPurchaseInfo.unit_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "50%"
    ...
    on: {
      "change": [function($event) {
        ...
        _vm.newItemPurchaseInfo.unit_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }, function($event) {
        _vm.findUnitName()
      }]
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemPurchaseInfo.account_id),
      expression: "newItemPurchaseInfo.account_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "100%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newItemPurchaseInfo.account_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("Cost of Goods Sold")])])])])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-3 control-label"
  }, [_vm._v("Description")]), _vm._v(" "), _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemPurchaseInfo.description),
      expression: "newItemPurchaseInfo.description"
    }],
    staticClass: "form-control",
    domProps: {
      "value": (_vm.newItemPurchaseInfo.description)
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItemPurchaseInfo.description = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Reorder Level")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-6"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemPurchaseInfo.reorder_level),
      expression: "newItemPurchaseInfo.reorder_level"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "number"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItemPurchaseInfo.reorder_level = $event.target.value
      },
      "blur": function($event) {
        _vm.$forceUpdate()
      }
    ...
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Opening Stock")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-6"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItemPurchaseInfo.opening_stock),
      expression: "newItemPurchaseInfo.opening_stock"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "number"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItemPurchaseInfo.opening_stock = $event.target.value
      },
      "blur": function($event) {
        _vm.$forceUpdate()
      }
    ...
    staticClass: "col-md-offset-1 col-md-8"
  }, [_c('h4', [_vm._v("Unit Conversion")]), _vm._v("\n                    1 " + _vm._s(_vm.purchaseUnit) + " =  "), _c('div', {
    staticClass: "input-group col-md-4"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newItem.conversion_qty),
      expression: "newItem.conversion_qty"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "text",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newItem.conversion_qty = $event.target.value
      }
    }
  }), _vm._v(" "), _c('span', {
    staticClass: "input-group-addon"
  }, [_vm._v("\n                          " + _vm._s(_vm.retailUnit) + "\n                      ")])])])])]), _vm._v(" "), _c('p', [_vm._v("Initial Stock will be updated in the Primary warehouse")]), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('div', {
    ...
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Unit Conversion")]), _vm._v(" "), _c('div', {
  ...
  return _c('label', {
    ...
    attrs: {
      "data-toggle": "tooltip",
      "data-placement": "top",
      "title": "Stock keeping unit for this item"
    }
  })])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('label', {
    ...
    attrs: {
      "data-toggle": "tooltip",
      "data-placement": "top",
      "title": "Twelve digit unique number associated with bar code (Universal Product Code)"
    }
  })])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('label', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-ebd5c890", module.exports)
  }
}
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Items\\AddItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ebd5c890", Component.options)
  } else {
    hotAPI.reload("data-v-ebd5c890", Component.options)
  }
})()}
