...
/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function mounted() {
        ...
        this.fetchItemSalesInfo();
        this.fetchItemPurchaseInfo();
        this.userCurrentCorpId = __WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].getCorporationId(this);
    },


    data: function data() {
        return {
            userCurrentCorpId: null,
            purchaseUnit: null,
            retailUnit: null,
            formIsSubmitted: false,
            saveText: '<i class="fa fa-spinner fa-spin"></i> UPDATING...',
            newItem: {
                unit_id: null,
                item_name: null,
                item_desc: null,
    ...
    methods: {
        findUnitName: function findUnitName() {
            ...
            this.newItemSalesInfo.retail_unit = queryResultForRetailUnit[0].unit_name;
            this.newItemPurchaseInfo.purchase_unit = queryResultForPurchaseUnit[0].unit_name;
            // console.log("Retail unit " + this.retailUnit + "Purchase unit " + this.purchaseUnit)
        },
        updateItem: function updateItem() {
            ...
            console.log(JSON.stringify(newItemUnit));

            this.$http.put(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/items/' + this.itemId, { item: this.newItem, sales_info: this.newItemSalesInfo, purchase_info: this.newItemPurchaseInfo, item_units: newItemUnit }).then(function (response) {

                alert("Item has been updated !!!");
                _this.$router.push({ path: '/items/' + _this.itemId });
        ...
        fetchResourceData: function fetchResourceData() {
            ...
            this.loading = true;
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/items/' + this.itemId + '/edit').then(function (response) {
                _this2.$set(_this2, 'newItem', response.data[0]);
        ...
        fetchItemSalesInfo: function fetchItemSalesInfo() {
            var _this3 = this;

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/items/' + this.itemId + '/sales-info').then(function (response) {

                _this3.$set(_this3, 'newItemSalesInfo', response.data[0]);
                console.log(response);
            });
        },
        fetchItemPurchaseInfo: function fetchItemPurchaseInfo() {
            var _this4 = this;

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/items/' + this.itemId + '/purchase-info').then(function (response) {

                _this4.$set(_this4, 'newItemPurchaseInfo', response.data[0]);
                console.log(response);
            });
        },
        fetchUnits: function fetchUnits() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/units').then(function (response) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("Edit Item")])]), _vm._v(" "), _c('form', {
    ...
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Retail Unit")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-8"
  }, [_c('div', {
    staticClass: "m-b"
  }, [_c('select', {
    ...
    staticClass: "col-md-3 control-label required-field"
  }, [_vm._v("Purchase Unit")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-offset-1 col-md-8"
  }, [_c('div', {
    staticClass: "m-b"
  }, [_c('select', {
    ...
    staticClass: "col-md-offset-1 col-md-8"
  }, [_c('h4', [_vm._v("Unit Conversion")]), _vm._v("\n                    1 " + _vm._s(_vm.newItemPurchaseInfo.purchase_unit) + " =  "), _c('div', {
  ...
  }, [_vm._v("\n                          " + _vm._s(_vm.newItemSalesInfo.retail_unit) + "\n                      ")])])])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('div', {
  ...
  }) : _vm._e(), _vm._v(" "), (!_vm.formIsSubmitted) ? _c('span', [_vm._v(" UPDATE ")]) : _vm._e()]), _vm._v(" "), _c('button', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-209e0a09", module.exports)
  }
}
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Items\\EditItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-209e0a09", Component.options)
  } else {
    hotAPI.reload("data-v-209e0a09", Component.options)
  }
})()}
