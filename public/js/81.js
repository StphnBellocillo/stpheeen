...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\PurchaseReceivings\\AddBill.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddBill.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-54f7daca", Component.options)
  } else {
    hotAPI.reload("data-v-54f7daca", Component.options)
  }
})()}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            userCorporationId: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this),
            total: 0.00,
            ...
            newBill: {
                ...
                payment_terms: null,
                bill_due_date: null,
                bill_expected_delivery_start_date: null,
                bill_total_amount: '0.00',
                bill_balance_due: null,
                bill_discount_percentage: null,
                bill_discounted_amount: 0.00,
                bill_tax_amount: '0.00'
            },
            billItems: {
                bill_id: null,
                item_id: null,
    ...
    computed: {
        taxTotal: function taxTotal() {
            ...
            this.purchaseReceiveItems.forEach(function (row) {
        ...
        grandTotal: function grandTotal() {
            var total = 0.00;
            total = parseFloat(this.purchaseReceive.purchase_rcvd_total_amount) + parseFloat(this.purchaseReceive.po_freight_charge_amount) + parseFloat(this.taxTotal) - this.purchaseReceive.purchase_rcvd_discounted_amount;
            return Number(total).toFixed(2);
        },
        subTotal: function subTotal() {

            console.log("Received items " + JSON.stringify(this.purchaseReceiveItems));
            var subtotal = 0.00;
            this.purchaseReceiveItems.forEach(function (item) {
                return subtotal += parseFloat(item.purchase_rcvd_item_qty_received) * parseFloat(item.purchase_price);
            });
    ...
    methods: {
        getSubTotal: function getSubTotal() {
            ...
            this.totalCalculatedReceivedAmount = parseFloat(subtotal) + parseFloat(this.purchaseOrder.po_freight_charge_amount);
            return Number(subtotal).toFixed(2);
        },
        addBill: function addBill() {
            ...
            this.newBill = {
                ...
                purchase_rcvd_id: this.orderNumber,
                contact_id: this.purchaseReceive.contact_id,
                whouse_id: this.purchaseReceive.whouse_id,
                bill_date: this.purchaseReceive.po_date,
                bill_status: 'Issued',
                bill_notes: this.purchaseReceive.po_notes,
                bill_ref_no: this.purchaseReceive.po_ref_no,
                bill_payment_terms: this.purchaseReceive.payment_terms,
                bill_due_date: this.purchaseReceive.po_due_date,
                bill_total_amount: this.purchaseReceive.purchase_rcvd_total_amount,
                bill_balance_due: this.purchaseReceive.purchase_rcvd_total_amount,
                bill_discount_percentage: this.purchaseReceive.purchase_rcvd_discount_percentage,
                bill_discounted_amount: this.purchaseReceive.purchase_rcvd_discounted_amount,
                bill_tax_amount: this.purchaseReceive.purchase_rcvd_tax_amount
            };

            console.log("Merchandise inventory is " + this.totalCalculatedReceivedAmount);
            console.log("Trade payable is " + parseFloat(this.newBill.bill_total_amount));
            console.log("Merchandise inventory is " + this.totalCalculatedReceivedAmount - this.purchaseOrder.po_freight_charge_amount);
            this.formIsSubmitted = true;
            console.log(this.newBill);

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/bills/create', this.newBill).then(function (response) {
                console.log(response.data);

                return _this2.addBillItems(response.data);
            }, function (response) {
        ...
        addBillItems: function addBillItems(data) {
            var _this3 = this;

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/bill-items/create', { rows: this.purchaseReceiveItems, bill_id: data.bill_id }).then(function (response) {
        ...
        fetchResourceData: function fetchResourceData() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/purchase-receivings/' + this.orderNumber).then(function (response) {
                _this4.$set(_this4, 'purchaseReceive', response.data.purchase_receive[0]);
                _this4.$set(_this4, 'purchaseReceiveItems', response.data.items);
                _this4.fetchPurchaseOrder();
            });
        },
        fetchPurchaseOrder: function fetchPurchaseOrder() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/purchase-orders/' + this.purchaseReceive.po_id).then(function (response) {

                //setting all accounts from the server response
                _this5.$set(_this5, 'purchaseOrder', response.data.purchaseorder);

                _this5.loading = false;
            }, function (response) {
                // error
                _this5.error = response.statusText;
                _this5.stopLoadingPlease();
            });
        },
        createJournal: function createJournal() {
            ...
            var journal = {
                ...
                'currency_id': 1,
                'journ_date': this.newBill.bill_date,
                'journ_reference_number': this.newBill.bill_ref_no,
                'journ_notes': this.newBill.bill_notes,
                'journ_total_amount': Number(parseFloat(this.purchaseReceive.purchase_rcvd_total_amount) + parseFloat(this.purchaseReceive.purchase_rcvd_discounted_amount)).toFixed(2),
                'corp_id': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this),
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                return _this6.createJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createJournalEntries: function createJournalEntries(journalId) {
            ...
            // input tax
            {
                ...
                tax_id: 1,
                contact_id: this.newBill.contact_id,
                entry_debit: parseFloat(this.newBill.bill_tax_amount),
                entry_credit: 0.00,
                ...
                contact_id: this.newBill.contact_id,
                entry_debit: 0.00,
                entry_credit: parseFloat(this.newBill.bill_total_amount),
                ...
                contact_id: this.newBill.contact_id,
                entry_debit: 0.00,
                entry_credit: this.newBill.bill_discounted_amount,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" Back to Bills\n            ")])], 1), _vm._v(" "), _c('div', {
    staticClass: "title"
  }, [_vm._v("New Bill")])]), _vm._v(" "), _c('form', {
  ...
  }, [_vm._v("Vendor Name")]), _vm._v(" "), _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.purchaseReceive.contact_id),
      expression: "purchaseReceive.contact_id"
    }],
    ...
    on: {
      "change": function($event) {
        ...
        _vm.purchaseReceive.contact_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    domProps: {
  ...
  }, [_vm._v("\n                                    " + _vm._s(_vm.purchaseReceive.contact_company_name) + "\n                                ")])])]), _vm._v(" "), _c('p', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.purchaseReceive.whouse_id),
      expression: "purchaseReceive.whouse_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "50%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.purchaseReceive.whouse_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    domProps: {
  ...
  }, [_vm._v("\n                                    " + _vm._s(_vm.purchaseReceive.whouse_name) + "\n                                ")])])])])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
  }, [_c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.purchaseReceive.po_ref_no),
      expression: "purchaseReceive.po_ref_no"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.purchaseReceive.po_ref_no = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.purchaseReceive.po_id),
      expression: "purchaseReceive.po_id"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "text"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.purchaseReceive.po_id = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-2 control-label"
  }, [_vm._v("Bill Date")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.purchaseReceive.po_date),
      expression: "purchaseReceive.po_date"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "date"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.purchaseReceive.po_date = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.purchaseReceive.payment_terms),
      expression: "purchaseReceive.payment_terms"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "50%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.purchaseReceive.payment_terms = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    domProps: {
  ...
  }, [_vm._v("\n                                    " + _vm._s(_vm.purchaseReceive.payment_terms) + "\n                                ")])])])])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
  }, [_c('table', {
    staticClass: "table table-bordered"
  }, [_vm._m(0), _vm._v(" "), _c('tbody', _vm._l((_vm.purchaseReceiveItems), function(item, index) {
    return _c('tr', {
      key: item
    }, [_c('td', [_c('select', {
      directives: [{
    ...
    }, [_vm._v("\n                                        " + _vm._s(item.item_sku) + " \n                                    ")])]), _c('hr'), _vm._v(" "), _c('p', [_c('strong', [_vm._v(_vm._s(item.item_name) + " ")])]), _vm._v(" "), _c('p', [_vm._v(" " + _vm._s(item.item_desc) + " ")])]), _vm._v(" "), _c('td', [_c('select', {
      directives: [{
        name: "model",
        rawName: "v-model",
      ...
      on: {
        "change": function($event) {
          ...
          item.account_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
        }
      }
    }, [_c('option', {
      attrs: {
    ...
    }, [_vm._v("\n                                    " + _vm._s(item.acct_name) + " \n                                     ")])])]), _vm._v(" "), _c('td', [_vm._v("\n                                 " + _vm._s(item.purchase_rcvd_item_qty_received) + "\n                            ")]), _vm._v(" "), _c('td', [_vm._v("\n                                 " + _vm._s(item.purchase_price) + "\n                            ")]), _vm._v(" "), _c('td', [_vm._v("\n                                PHP " + _vm._s(item.purchase_rcvd_item_qty_received * item.purchase_price) + "\n                            ")])])
  ...
  }, [_c('strong', [_vm._v("\n                                 " + _vm._s(_vm.purchaseReceive.purchase_rcvd_total_amount) + "\n                            ")])])]), _vm._v(" "), _c('tr', [_c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "4"
    }
  }, [_vm._v("Purchase Discount (" + _vm._s(_vm.purchaseReceive.po_discount_percentage) + "%)")]), _vm._v(" "), _c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("\n                               " + _vm._s(_vm.purchaseReceive.purchase_rcvd_discounted_amount) + "\n                            ")])]), _vm._v(" "), _c('tr', [_c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "4"
    }
  }, [_c('strong', [_vm._v("FREIGHT CHARGES")])]), _vm._v(" "), _c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "2"
    }
  }, [_c('strong', [_vm._v("\n                                 " + _vm._s(_vm.purchaseReceive.po_freight_charge_amount) + "\n                            ")])])]), _vm._v(" "), _c('tr', [_c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "4"
    }
  ...
  }, [_vm._v("\n                                " + _vm._s(Number(_vm.purchaseReceive.purchase_rcvd_tax_amount * .89285714285).toFixed(2)) + "\n                            ")])]), _vm._v(" "), _c('tr', [_c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "4"
    }
  ...
  }, [_vm._v("\n                                " + _vm._s(_vm.purchaseReceive.purchase_rcvd_tax_amount) + "\n                            ")])])])], 1)]), _vm._v(" "), _c('div', {
    staticClass: "stripe"
  }, [_c('div', {
    staticClass: "form-group ",
    staticStyle: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.purchaseReceive.po_notes),
      expression: "purchaseReceive.po_notes"
    }],
    staticClass: "form-control",
    attrs: {
      "rows": "2"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.purchaseReceive.po_notes = $event.target.value
      }
    }
  }, [_vm._v("\n                        " + _vm._s(_vm.purchaseReceive.po_notes) + "\n                        ")])])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('div', {
  ...
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Item Details")]), _vm._v(" "), _c('th', [_vm._v("Account")]), _vm._v(" "), _c('th', [_vm._v("Quantity")]), _vm._v(" "), _c('th', [_vm._v("Rate")]), _vm._v(" "), _c('th', [_vm._v("AMOUNT")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-54f7daca", module.exports)
  }
}
