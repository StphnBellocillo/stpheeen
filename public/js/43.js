...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.invoices.length == 0) ? _c('button', {
  ...
  }, [(_vm.soPickLists.length == 0) ? _c('li', [_c('a', {
    staticClass: "dropdown-item",
    attrs: {
      "data-toggle": "modal",
      "href": "#modal-add-to-picklist"
    }
  }, [_vm._v("Add to Pick List")])]) : _vm._e(), _vm._v(" "), _c('li', {
    staticClass: "divider"
  }), _vm._v(" "), _vm._m(1)])])]), _vm._v(" "), (!_vm.loading) ? _c('div', {
    staticClass: "title"
  ...
  }, [_vm._m(3), _vm._v(" "), _c('tbody', [_vm._l((_vm.invoices), function(invoice) {
    ...
    }, [_c('td', [_vm._v(" " + _vm._s(invoice.inv_no) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(invoice.inv_date) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(invoice.inv_status) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(invoice.inv_due_date) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(Number(invoice.inv_total_amount).toFixed(2)) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(invoice.inv_balance_amount) + " ")])]) : _vm._e()
  }), _vm._v(" "), _c('tr', {
    directives: [{
      name: "show",
      rawName: "v-show",
    ...
    staticClass: "table table-hover"
  }, [_vm._m(4), _vm._v(" "), _c('tbody', [_vm._l((_vm.soPickLists), function(picklist) {
    return (_vm.soPickLists.length != 0) ? _c('tr', {
      staticStyle: {
        "cursor": "pointer"
      },
      on: {
    ...
    }, [_c('td', [_vm._v(" " + _vm._s(picklist.pick_list_no) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(picklist.created_at) + " ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(picklist.pick_list_status) + " ")])]) : _vm._e()
  }), _vm._v(" "), _c('tr', {
    directives: [{
      name: "show",
      rawName: "v-show",
  ...
  }, [(_vm.salesOrder.so_status == 'Draft') ? _c('span', {
  ...
  }, [_vm._v("\n                 " + _vm._s(_vm.salesOrder.so_status) + "\n               ")]) : _vm._e(), _vm._v(" "), (_vm.salesOrder.so_status == 'Confirmed') ? _c('span', {
    staticClass: "pull-right",
    staticStyle: {
  ...
  }, [_c('thead', [_c('tr', [_c('th', [_vm._v("ITEMS & DESCRIPTION")]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.salesOrderItems[0].purchase_unit_name) + " ")]), _vm._v(" "), _c('th', [_vm._v(_vm._s(_vm.salesOrderItems[0].sales_unit) + " ")]), _vm._v(" "), _c('th', [_vm._v("RATE")]), _vm._v(" "), _c('th', [_vm._v("AMOUNT")])])]), _vm._v(" "), _c('tbody', [_vm._l((_vm.salesOrderItems), function(item) {
    return _c('tr', [_c('td', {
      attrs: {
        "width": "55%"
      }
    }, [_vm._v("\n                               [ " + _vm._s(item.item_sku) + " ]  " + _vm._s(item.item_name) + " \n                               " + _vm._s(item.item_desc) + " \n                           ")]), _vm._v(" "), (parseFloat(item.so_item_qty) < parseFloat(item.conversion_qty)) ? _c('td', [_vm._v(" 0 ")]) : _vm._e(), _vm._v(" "), (parseFloat(item.so_item_qty) < parseFloat(item.conversion_qty)) ? _c('td', [_vm._v(_vm._s(item.so_item_qty) + " ")]) : _vm._e(), _vm._v(" "), (parseFloat(item.so_item_qty) >= parseFloat(item.conversion_qty)) ? _c('td', [_vm._v(" " + _vm._s(Math.floor(parseInt(item.so_item_qty) / parseInt(item.conversion_qty))) + "  ")]) : _vm._e(), _vm._v(" "), (parseFloat(item.so_item_qty) >= parseFloat(item.conversion_qty)) ? _c('td', [_vm._v(_vm._s(item.so_item_qty % item.conversion_qty) + "  ")]) : _vm._e(), _vm._v(" "), _c('td', [_vm._v("\n                               " + _vm._s(item.so_item_rate) + "\n                           ")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(item.so_item_rate * item.so_item_qty, 'PHP', 2)) + " ")])])
  ...
  return _c('thead', [_c('tr', [_c('th', [_vm._v("INVOICE #")]), _vm._v(" "), _c('th', [_vm._v("DATE")]), _vm._v(" "), _c('th', [_vm._v("STATUS")]), _vm._v(" "), _c('th', [_vm._v("DUE DATE")]), _vm._v(" "), _c('th', [_vm._v("AMOUNT")]), _vm._v(" "), _c('th', [_vm._v("BALANCE DUE")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("PICKLIST #")]), _vm._v(" "), _c('th', [_vm._v("DATE")]), _vm._v(" "), _c('th', [_vm._v("STATUS")])])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7528b9e0", module.exports)
  }
}
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Sales Orders\\ViewSalesOrder.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] ViewSalesOrder.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7528b9e0", Component.options)
  } else {
    hotAPI.reload("data-v-7528b9e0", Component.options)
  }
})()}
