...
var url = 'http://compacct.app/api/v1/';



/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function mounted() {
        // alert("i am removing plugins")
        this.initializePlugins();
        this.poNumber = this.$route.query.po_no;
    ...
    computed: {
        subTotal: function subTotal() {
            var vm = this;
            var total = 0.00;
            this.purchaseOrderItems.map(function (item, key) {

                total += (parseInt(item.purchse_order_item_qty) - parseInt(vm.prItems[key].purchase_rcvd_item_qty_received)) * parseFloat(item.purchse_order_item_rate);
            });
        ...
        taxTotal: function taxTotal() {
            ...
            this.newPurchaseReturn.purchase_rturn_tax_amount = taxAmount;
            return Number(taxAmount).toFixed(2);
        },
        discountedAmount: function discountedAmount() {
            var discountAmount = Number(this.subtotalAmount * this.purchaseOrder.po_discount_percentage / 100);
            console.log("Discounted amount is " + discountAmount);
            this.newPurchaseReturn.purchase_rturn_discounted_amount = discountAmount;
            return discountAmount;
        },
        grandTotal: function grandTotal() {
            this.total = Number(this.subtotalAmount - this.discountedAmount) * 1.12;
            this.newPurchaseReturn.purchase_rturn_total_amount = this.total;
            return this.total;
        }
    },
    ...
    methods: {
        addPurchaseReturn: function addPurchaseReturn() {
            var _this = this;

            this.newPurchaseReturn.purchase_rturn_discount_percentage = this.purchaseOrder.po_discount_percentage;
            this.newPurchaseReturn.po_id = this.poId;

            this.formIsSubmitted = true;
            this.newPurchaseReturn.corp_id = __WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].getCorporationId(this);
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/purchase-returns/create', this.newPurchaseReturn).then(function (response) {
                console.log(response.data);

                return _this.addPurchaseReturnItems(response.data);
            }, function (response) {
        ...
        addPurchaseReturnItems: function addPurchaseReturnItems(data) {
            var _this2 = this;

            var vm = this;
            var purchaseReturnItems = [];
            var purchaseReturnItem = {};

            this.purchaseOrderItems.map(function (item, key) {
                var returnQty = parseInt(item.purchse_order_item_qty) - parseInt(vm.prItems[key].purchase_rcvd_item_qty_received);

                purchaseReturnItem.item_id = item.item_id;
                purchaseReturnItem.purchase_rturn_item_rate = item.purchse_order_item_rate;
                purchaseReturnItem.purchase_rturn_item_ordered_qty = item.purchse_order_item_qty;
                purchaseReturnItem.purchase_rturn_item_received_qty = vm.prItems[key].purchase_rcvd_item_qty_received;
                purchaseReturnItem.purchase_rturn_item_qty = returnQty;
                purchaseReturnItems.push(purchaseReturnItem);
                //reset
                purchaseReturnItem = {};
            });

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/purchase-return-items/create', { rows: purchaseReturnItems, purchase_rturn_id: data.purchase_rturn_id }).then(function (response) {

                console.log(response.data);
                _this2.loading = false;
                alert("Purchase Return has been created !");
                _this2.$router.push({ path: '/purchase-returns/' + data.purchase_rturn_id });
            }, function (response) {
        ...
        fetchPurchaseOrder: function fetchPurchaseOrder() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/purchase-orders/' + this.poId).then(function (response) {
            ...
            this.newPurchaseReturn.contact_id = this.purchaseOrder.contact_id;
        },
        fetchReceivedItems: function fetchReceivedItems() {
            var _this4 = this;

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/purchase-receivings/events/get-by-purchase-order?po_id=' + this.poId).then(function (response) {
                console.log(response.statusText);
                _this4.$set(_this4, 'prItems', response.data.pr_items);
            });
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.poNumber) + " / New Purchase Return ")])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.loading),
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newPurchaseReturn.purchase_rturn_ref_no),
      expression: "newPurchaseReturn.purchase_rturn_ref_no"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newPurchaseReturn.purchase_rturn_ref_no = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Supplier ")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newPurchaseReturn.contact_id),
      expression: "newPurchaseReturn.contact_id"
    }],
    staticClass: "form-control m-b",
    staticStyle: {
      "width": "100%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newPurchaseReturn.contact_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
    ...
    domProps: {
      "value": _vm.purchaseOrder.contact_id
    }
  }, [_vm._v(" " + _vm._s(_vm.purchaseOrderItems[0].contact_company_name) + " ")])])])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-2 control-label required-field"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newPurchaseReturn.purchase_rturn_date),
      expression: "newPurchaseReturn.purchase_rturn_date"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "date"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newPurchaseReturn.purchase_rturn_date = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
    ...
    }, [_vm._v("\n                                     [" + _vm._s(row.item_sku) + " " + _vm._s(row.item_name) + " "), _c('br'), _vm._v("\n                                     " + _vm._s(row.item_desc) + "\n                                ")]), _vm._v(" "), _c('td', [_vm._v("\n                                    " + _vm._s(_vm._f("currency")(row.purchse_order_item_rate, 'PHP', 2)) + " \n                                ")]), _vm._v(" "), _c('td', [_vm._v("\n                                  " + _vm._s(row.purchse_order_item_qty) + "\n                                ")]), _vm._v(" "), (_vm.prItems.length == 0) ? _c('td', [_vm._v("\n                                      0\n                                ")]) : _vm._e(), _vm._v(" "), (_vm.prItems.length != 0) ? _c('td', [_vm._v("\n                                  " + _vm._s(_vm.prItems[index].purchase_rcvd_item_qty_received) + "\n                                ")]) : _vm._e(), _vm._v(" "), _c('td', [_vm._v("\n                                     " + _vm._s(parseInt(row.purchse_order_item_qty) - parseInt(_vm.prItems[index].purchase_rcvd_item_qty_received)) + "\n                                ")]), _vm._v(" "), _c('td', [_vm._v("\n                                     " + _vm._s(_vm._f("currency")((parseInt(row.purchse_order_item_qty) - parseInt(_vm.prItems[index].purchase_rcvd_item_qty_received)) * parseFloat(row.purchse_order_item_rate), 'PHP', 2)) + "\n                                ")])])
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("SUBTOTAL")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.subTotal, 'PHP', 2)) + " ")])]), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("TOTAL")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.grandTotal, 'PHP', 2)) + " ")])]), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("VAT")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.taxTotal, 'PHP', 2)) + " ")])]), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td', {
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("DISCOUNT(" + _vm._s(_vm.purchaseOrder.po_discount_percentage) + "%)")]), _vm._v(" "), _c('td', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.discountedAmount, 'PHP', 2)))])])], 2)])]), _vm._v(" "), _c('div', {
    staticClass: "stripe"
  }, [_c('div', {
    staticClass: "form-group ",
    staticStyle: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newPurchaseReturn.purchase_rturn_notes),
      expression: "newPurchaseReturn.purchase_rturn_notes"
    }],
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newPurchaseReturn.purchase_rturn_notes = $event.target.value
      }
    }
  }, [_vm._v("\n                     Shortlanded delivery\n                 ")])])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  }, [_c('div', {
  ...
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Item & Desc")]), _vm._v(" "), _c('th', [_vm._v("PURCHASE PRICE")]), _vm._v(" "), _c('th', [_vm._v("ORDERED")]), _vm._v(" "), _c('th', [_vm._v("RECEIVED")]), _vm._v(" "), _c('th', [_vm._v("QTY TO RETURN")]), _vm._v(" "), _c('th', [_vm._v("RETURN VALUE")])])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-18d9f4f8", module.exports)
  }
}
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\PurchaseReturns\\AddPurchaseReturn.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddPurchaseReturn.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-18d9f4f8", Component.options)
  } else {
    hotAPI.reload("data-v-18d9f4f8", Component.options)
  }
})()}
