...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\StockAdjustments\\AddStockAdjustment.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddStockAdjustment.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-611f32b4", Component.options)
  } else {
    hotAPI.reload("data-v-611f32b4", Component.options)
  }
})()}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_instant_dist_vue_instant_css__ = __webpack_require__(177);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_instant_dist_vue_instant_common__ = __webpack_require__(178);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            selectedEvent: "",
            newStockTransfer: {
                stock_transfer_status: 'Transferred'
            },
            errors: [],
    ...
    methods: {
        fetchAllInventoryItems: function fetchAllInventoryItems() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/warehouse-items').then(function (response) {
                ...
                _this.$set(_this, 'warehouseItemLogs', response.data.warehouse_item_logs);
                _this.loading = false;
            });
        },
        ...
        populateFields: function populateFields(index) {
            ...
            this.rows[index].transfer_qty = 1;
        ...
        addStockTransfer: function addStockTransfer() {
            var _this2 = this;

            this.formIsSubmitted = true;
            this.newStockTransfer.corp_id = __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this);
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/stock-transfers/create', this.newStockTransfer).then(function (response) {
                console.log(response.data);

                return _this2.addStockTransferItems(response.data);
            }, function (response) {
        ...
        addStockTransferItems: function addStockTransferItems(data) {
            var _this3 = this;

            console.log("Rows" + this.rows);
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/stock-transfer-items/create', { rows: this.rows, stock_transfer_id: data.stock_transfer_id }).then(function (response) {

                console.log(response.data);
                _this3.loading = false;
                alert("Stock transfer has been created !");
                _this3.$router.push({ path: '/stock-transfers/' + data.stock_transfer_id });
            }, function (response) {
        ...
        fetchItems: function fetchItems() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=sales').then(function (response) {
                console.log(response.statusText);
                _this5.$set(_this5, 'items', response.data);
            });
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v("\n             Back to Stock Adjustment")])])], 1), _vm._v(" "), _c('div', {
    staticClass: "title"
  }, [_vm._v("New Stock Adjustment ")])]), _vm._v(" "), (_vm.error) ? _c('div', {
    ref: "formErrors",
    staticClass: "alert",
    staticStyle: {
      "background": "#f0f0f0"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newStockTransfer.stock_transfer_ref_no),
      expression: "newStockTransfer.stock_transfer_ref_no"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newStockTransfer.stock_transfer_ref_no = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Source Warehouse ")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newStockTransfer.source_warehouse),
      expression: "newStockTransfer.source_warehouse"
    }],
    staticClass: "form-control m-b",
    staticStyle: {
      "width": "100%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newStockTransfer.source_warehouse = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Destination Warehouse ")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newStockTransfer.destination_warehouse),
      expression: "newStockTransfer.destination_warehouse"
    }],
    staticClass: "form-control m-b",
    staticStyle: {
      "width": "100%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newStockTransfer.destination_warehouse = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, _vm._l((_vm.warehouses), function(warehouse) {
    return _c('option', {
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Transfer Date")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newStockTransfer.stock_transfer_date),
      expression: "newStockTransfer.stock_transfer_date"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "required": "",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newStockTransfer.stock_transfer_date = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
    ...
    return _c('tr', {
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          row.transfer_qty = $event.target.value
        },
        "blur": function($event) {
          _vm.$forceUpdate()
        }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newStockTransfer.stock_transfer_notes),
      expression: "newStockTransfer.stock_transfer_notes"
    }],
    staticClass: "form-control",
    attrs: {
      "rows": "2"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newStockTransfer.stock_transfer_notes = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  ...
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Item & Desc")]), _vm._v(" "), _c('th', [_vm._v("Transfer Quantity")]), _vm._v(" "), _c('th')])])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-611f32b4", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("30029e0c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-611f32b4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddStockAdjustment.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-611f32b4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddStockAdjustment.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
