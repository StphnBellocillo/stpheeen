...
/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function mounted() {
        ...
        this.fetchContacts();
        this.corp_name = __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationName(this);
        this.fetchTransactions();
    },


    computed: {
        totalRMRAmount: function totalRMRAmount() {
            var total = 0.00;
            if (this.transactions != null) {

                this.transactions.forEach(function (transaction) {
                    return total += parseFloat(transaction.rmr_total);
                });
            }
            return total;
        },
    ...
    methods: {
        ...
        exportToExcel: function exportToExcel() {
            window.open('/exports/reports/per-rmr?type=excel&corp_id=' + __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this) + '&date_from=' + this.date_from + '&date_to=' + this.date_to, '_blank');
        },
        print: function print() {
            this.$router.push({ path: '/reports/per-rmr/print' });
        },
        getTotalPerRMR: function getTotalPerRMR(rmrId) {
            var total = 0.00;
            if (this.transactions != null) {
        ...
        fetchTransactions: function fetchTransactions() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/reports/generate/per-rmrs?date_from=' + this.date_from + '&date_to=' + this.date_to).then(function (response) {
                // console.log(response.statusText);
                _this.$set(_this, 'transactions', response.data.rmrs);
                _this.loading = false;
                _this.fetchTransactionReasons();
            });
        },
        fetchTransactionReasons: function fetchTransactionReasons() {
            var reasons = [];
            var queryResult = linq.from(this.transactions).toArray();
            queryResult.forEach(function (transaction) {
                return reasons.push(transaction.return_reason);
            });
            this.returnReasons = linq.from(reasons).distinct().toArray();
        },
        fetchTransactionsByReason: function fetchTransactionsByReason(returnReason) {
            var queryResult = linq.from(this.transactions).where(function (transaction) {
                return transaction.return_reason == returnReason;
            }).toArray();
            console.log(JSON.stringify(queryResult));
            return queryResult;
        },
        getTotal: function getTotal(reason) {
            var queryResult = linq.from(this.transactions).where(function (transaction) {
                return transaction.return_reason == reason;
            }).toArray();

            return linq.from(queryResult).sum("x => parseFloat(x.rmr_total)");
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("Returned Materials By Customer")])]), _vm._v(" "), _c('div', {
    ...
    staticStyle: {
      "font-family": "'Proxima Nova Thin','Arial'"
    }
  }, [_vm._v("\n                    " + _vm._s(_vm.corp_name) + "\n                ")]), _vm._v(" "), _c('p', [_vm._v(" Returned Materials By Customer ")]), _vm._v(" "), (_vm.date_from) ? _c('p', [_vm._v("From " + _vm._s(_vm.date_from) + " to " + _vm._s(_vm.date_to) + " ")]) : _vm._e()]), _vm._v(" "), _c('table', {
  ...
  })]) : _vm._e(), _vm._v(" "), _vm._l((_vm.returnReasons), function(reason) {
    return (_vm.transactions.length != 0) ? _c('tr', [_c('td', [_vm._v(" " + _vm._s(reason) + " ")]), _vm._v(" "), _c('td', {
      staticStyle: {
        "position": "relative",
        "right": "200px !important"
      }
    }, [_vm._m(1, true), _vm._v(" "), _c('tbody', [_vm._l((_vm.fetchTransactionsByReason(reason)), function(customer) {
      return _c('tr', [_c('td', [_vm._v(_vm._s(customer.contact_company_name))]), _vm._v(" "), _c('td', {
        staticStyle: {
          "position": "absolute",
          "left": "500px !important"
        }
      }, [_vm._v("\n                                                " + _vm._s(customer.return_date) + " \n                                            ")]), _vm._v(" "), _c('td', {
        staticStyle: {
          "position": "absolute",
          "left": "600px !important"
        }
      }, [_vm._v("\n                                                " + _vm._s(customer.return_qty) + " \n                                            ")]), _vm._v(" "), _c('td', {
        staticStyle: {
          "position": "absolute",
          "left": "700px !important"
        }
      }, [_vm._v("\n                                                " + _vm._s(customer.rmr_total) + "\n                                            ")])])
    }), _vm._v(" "), _c('tr', [_vm._m(2, true), _vm._v(" "), _c('td', {
      staticStyle: {
        "position": "absolute",
        "left": "700px !important",
        "margin-bottom": "20px !important"
      }
    }, [_c('strong', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.getTotal(reason), '', 2)) + " ")])])]), _c('Br'), _c('Br')], 2)])]) : _vm._e()
  })], 2)])]), _vm._v(" "), _c('div', {
  ...
  }, [_vm._v("Filter")])])]), _vm._v(" "), _vm._m(4)])])])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Reason ")]), _vm._v(" "), _c('th')])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('thead', [_c('tr', [_c('th', [_vm._v("COMPANY NAME ")]), _vm._v(" "), _c('th', {
    staticStyle: {
      "position": "absolute",
      "left": "500px !important"
    }
  }, [_vm._v(" RETURN DATE ")]), _vm._v(" "), _c('th', {
    staticStyle: {
      "position": "absolute",
      "left": "600px !important"
    }
  }, [_vm._v("QTY ( pcs )")]), _vm._v(" "), _c('th', {
    staticStyle: {
      "position": "absolute",
      "left": "700px !important"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7c0cc90a", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("58856865", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7c0cc90a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ReportPerRMR.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7c0cc90a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./ReportPerRMR.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("651e5de6", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7c0cc90a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./ReportPerRMR.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7c0cc90a\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./ReportPerRMR.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Reports\\ReportPerRMR.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] ReportPerRMR.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c0cc90a", Component.options)
  } else {
    hotAPI.reload("data-v-7c0cc90a", Component.options)
  }
})()}
