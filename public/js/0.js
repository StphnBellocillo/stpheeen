...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Sales Orders\\EditSalesOrder.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] EditSalesOrder.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c5c0fc96", Component.options)
  } else {
    hotAPI.reload("data-v-c5c0fc96", Component.options)
  }
})()}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        taxTotal: function taxTotal() {
            ...
            this.salesOrderItems.forEach(function (row) {
        ...
        discountedAmount: function discountedAmount() {
            ...
            return this.newSalesOrder.so_discounted_amount = Number(this.newSalesOrder.so_discount_percentage * this.subTotal / 100).toFixed(2);
        },
        ...
        //     var grandTotal = 0
        //     this.salesOrderItems.forEach((row) => this.total =  ( this.subTotal - this.newSalesOrder.so_discounted_amount )  * 1.12 )    
    ...
    methods: {
        calculateDueDate: function calculateDueDate() {
            ...
            if (this.newSalesOrder.so_payment_terms == 'Net 7') {
                dueDate = __WEBPACK_IMPORTED_MODULE_3_moment___default()(this.newSalesOrder.so_order_date).add(7, 'days').format('YYYY-MM-DD');
            } else if (this.newSalesOrder.so_payment_terms == 'Net 10') {
                dueDate = __WEBPACK_IMPORTED_MODULE_3_moment___default()(this.newSalesOrder.so_order_date).add(10, 'days').format('YYYY-MM-DD');
            } else if (this.newSalesOrder.so_payment_terms == 'Net 15') {
                dueDate = __WEBPACK_IMPORTED_MODULE_3_moment___default()(this.newSalesOrder.so_order_date).add(15, 'days').format('YYYY-MM-DD');
            } else if (this.newSalesOrder.so_payment_terms == 'Net 30') {
                dueDate = __WEBPACK_IMPORTED_MODULE_3_moment___default()(this.newSalesOrder.so_order_date).add(30, 'days').format('YYYY-MM-DD');
            } else if (this.newSalesOrder.so_payment_terms == 'Net 45') {
                dueDate = __WEBPACK_IMPORTED_MODULE_3_moment___default()(this.newSalesOrder.so_order_date).add(45, 'days').format('YYYY-MM-DD');
            } else if (this.newSalesOrder.so_payment_terms == 'Net 60') {
                dueDate = __WEBPACK_IMPORTED_MODULE_3_moment___default()(this.newSalesOrder.so_order_date).add(60, 'days').format('YYYY-MM-DD');
            }
        ...
        setDefaultDate: function setDefaultDate() {
            ...
            this.newSalesOrder.so_order_date = __WEBPACK_IMPORTED_MODULE_3_moment___default()().format('YYYY-MM-DD');
        },
        ...
        findItemRate: function findItemRate(index) {
            ...
            var queryResult = linq.from(this.items).where(function (item) {
                return item.item_sku == vm.salesOrderItems[index].item_sku;
            }).toArray();
            console.log("query result from item " + JSON.stringify(queryResult[0]));
            // console.log("query resykt" + JqueryResult[0].retail_price)
            // populate the item rate
            this.salesOrderItems[index].so_item_rate = queryResult[0].retail_price;
            this.salesOrderItems[index].so_item_qty = 1;
            this.salesOrderItems[index].item_desc = queryResult[0].item_name + '-' + queryResult[0].item_desc;

            // populate the item id
            this.salesOrderItems[index].item_id = queryResult[0].item_id;
        ...
        findAccountName: function findAccountName(item, index) {
            ...
            // this.salesOrderItems[index].account_id = item.sales_info_id
            this.salesOrderItems[index].account_id = queryResult[0].acct_id;
            this.salesOrderItems[index].acct_name = queryResult[0].acct_name;
            // this.salesOrderItems[index].currentItemAccountName = queryResult[0].acct_name
        ...
        fetchTransactionDiscounts: function fetchTransactionDiscounts() {
            ...
            this.loading = true;
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/' + 'SOID-' + this.newSalesOrder.so_id).then(function (response) {

                _this3.$set(_this3, 'contactDiscounts', response.data);
                _this3.discountsLoaded = true;
        ...
        updateSalesOrder: function updateSalesOrder() {
            ...
            this.$http.put(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/sales-orders/' + this.soId + '/edit', this.newSalesOrder).then(function (response) {
                console.log(response.data);

                return _this4.updateSalesOrderItems(response.data);
            }, function (response) {
        ...
        updateSalesOrderItems: function updateSalesOrderItems(data) {
            var _this5 = this;

            console.log(this.rows);

            this.$http.put(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/sales-order-items/' + this.soId + '/edit', { rows: this.salesOrderItems, so_id: data.so_id }).then(function (response) {

                console.log(response.data);
                // return this.createJournal();
                _this5.loading = false;
                return _this5.updateTransactionDiscounts(data);
            }, function (response) {
        ...
        updateTransactionDiscounts: function updateTransactionDiscounts(data) {
            var _this6 = this;
            ...
            this.$http.put(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/' + this.newSalesOrder.so_no + '/edit', { contact_discounts: transactionDiscounts }).then(function (response) {

                console.log(response.data);
                _this6.loading = false;
                _this6.$router.push({ path: '/sales-orders' });
                alert('Sales order has been updated !');
            }, function (response) {
        ...
        fetchSalesOrder: function fetchSalesOrder() {
            var _this7 = this;

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/sales-orders/' + this.soId).then(function (response) {
                _this7.$set(_this7, 'salesOrderItems', response.data.items);
                _this7.$set(_this7, 'newSalesOrder', response.data.salesorder);
        ...
        fetchItems: function fetchItems() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=sales').then(function (response) {
                ...
                _this8.$set(_this8, 'items', response.data);
            });
        },
        ...
        fetchSalesPersons: function fetchSalesPersons() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/salespersons').then(function (response) {
                console.log(response.statusText);
                _this10.$set(_this10, 'salespersons', response.data);
            });
        },
        ...
        fetchTaxes: function fetchTaxes() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/taxes').then(function (response) {
                console.log(response.statusText);
                _this12.$set(_this12, 'taxes', response.data);
            });
        },
        fetchWarehouses: function fetchWarehouses() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/warehouses').then(function (response) {
                console.log(response.statusText);
                _this13.$set(_this13, 'warehouses', response.data);
            });
        },
        ...
        addRow: function addRow(index) {
            ...
            this.salesOrderItems.splice(index + 1, 0, { item_sku: null, item_id: null, account_id: null, tax_id: null, so_item_rate: null, so_item_qty: null, tax_amount: '0.00', row_total_amount: 0.00 });
            this.initializePlugins();
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("Edit Sales Order")])]), _vm._v(" "), (_vm.errors.length != 0) ? _c('div', {
    ref: "formErrors",
    staticClass: "alert",
    staticStyle: {
      "background": "#f0f0f0"
  ...
  }, [_vm._m(1), _vm._v(" "), _c('tbody', _vm._l((_vm.salesOrderItems), function(row, index) {
    return _c('tr', {
      key: row
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c5c0fc96", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("34ec9b3a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-c5c0fc96\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EditSalesOrder.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-c5c0fc96\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EditSalesOrder.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
