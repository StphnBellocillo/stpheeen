...
/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function mounted() {
        ...
        this.order_no = this.$route.query.order_number;
        this.fetchResourceData(this.order_no);
        this.markSalesOrderAsConfirmed(this.order_no);
    ...
    data: function data() {
        return {
            ...
            newInvoice: {
                ...
                inv_status: 'Draft',
                inv_date: null,
                inv_payment_terms: null,
                inv_due_date: null,
                inv_total_amount: null,
                inv_balance_amount: '0.00',
                inv_discount_percentage: null,
                inv_discounted_amount: '0.00',
                inv_customer_notes: null,
            ...
            salesOrder: {
                ...
                sales_person_id: null,
                contact_id: null,
                so_contact_company_name: null,
                so_ref_no: null,
                so_order_no: this.$route.query.order_number,
                so_status: 'Draft',
                so_date: null,
                so_payment_terms: null,
                so_due_date: null,
                so_total_amount: null,
                so_balance_amount: '0.00',
    ...
    computed: {
        ...
        discountedAmount: function discountedAmount() {
            ...
            return this.newInvoice.inv_discounted_amount = Number(this.newInvoice.inv_discount_percentage * this.subTotal / 100).toFixed(2);
        },
        ...
        grandTotal: function grandTotal() {
            ...
            var grandTotal = 0;
            this.salesOrderItems.forEach(function (row) {
                return _this2.total = (_this2.subTotal - _this2.salesOrder.so_discounted_amount) * 1.12;
            });
            this.newInvoice.inv_total_amount = Number(this.total).toFixed(2);
            this.newInvoice.inv_balance_amount = this.newInvoice.inv_total_amount;
            return this.newInvoice.inv_total_amount;
        }
    },
    methods: {
        markSalesOrderAsConfirmed: function markSalesOrderAsConfirmed() {
            var _this3 = this;

            this.loading = true;
            this.$http.put(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/sales-orders/' + this.order_no + '/update-status?status=Confirmed').then(function (response) {
        ...
        fetchResourceData: function fetchResourceData(salesOrderId) {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/sales-orders/' + salesOrderId).then(function (response) {

                _this4.$set(_this4, 'salesOrderItems', response.data.items);
                _this4.$set(_this4, 'salesOrder', response.data.salesorder);
                _this4.salesOrder.so_order_no = _this4.$route.query.order_number;
                _this4.prepareInvoiceItems(response.data.items);
        ...
        prepareInvoiceItems: function prepareInvoiceItems(salesOrderItems) {

            for (var x = 0; x < this.salesOrderItems.length; x++) {
                var item = {
                    item_id: salesOrderItems[x].item_id,
                    account_id: salesOrderItems[x].account_id,
                    tax_id: 1,
                    inv_item_rate: salesOrderItems[x].so_item_rate,
                    inv_item_qty: salesOrderItems[x].so_item_qty
                };
                this.merchandiseInventoryAmount += salesOrderItems[x].purchase_price * salesOrderItems[x].so_item_qty;
                this.invoiceRows.push(item);
            }

            console.log("Merchandise inventory total amount : " + this.merchandiseInventoryAmount);
        },
        tagAsDeliverable: function tagAsDeliverable() {
            var _this5 = this;

            // tag this as deliverable, this will determine that this
            // certain sales order has its own invoice already 
            // if this will be added on the picklist later on
            this.loading = true;
            this.$http.put(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/sales-orders/' + this.order_no + '/tag-as-deliverable?tag=YES').then(function (response) {
                console.log(response.data);
        ...
        addInvoice: function addInvoice() {
            ...
            this.newInvoice = {
                whouse_id: this.salesOrder.whouse_id,
                corp_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this),
                sales_person_id: this.salesOrder.sales_person_id,
                contact_id: this.salesOrder.contact_id,
                inv_ref_no: this.salesOrder.so_ref_no,
                inv_order_no: this.salesOrder.so_order_no,
                inv_status: 'Issued',
                inv_date: this.salesOrder.so_order_date,
                inv_payment_terms: this.salesOrder.so_payment_terms,
                inv_due_date: this.salesOrder.so_due_date,
                inv_total_amount: this.salesOrder.so_total_amount,
                inv_balance_amount: this.salesOrder.so_total_amount,
                inv_discount_percentage: this.salesOrder.so_discount_percentage,
                inv_discounted_amount: this.salesOrder.so_discounted_amount,
                inv_customer_notes: this.salesOrder.so_customer_notes
            };

            this.formIsSubmitted = true;
            console.log(this.newInvoice);
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoices/create', this.newInvoice).then(function (response) {
                console.log(response.data);
                _this6.tagAsDeliverable();
                return _this6.addInvoicedItems(response.data);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        addInvoicedItems: function addInvoicedItems(data) {
            var _this7 = this;

            // console.log("Rows " + JSON.stringify(this.invoiceRows) )
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoice-items/create', { rows: this.invoiceRows, inv_id: data.inv_id }).then(function (response) {
                console.log(response.data);
                return _this7.createSalesJournal();
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createSalesJournal: function createSalesJournal() {
            var vm = this;
            var salesJournal = {

                'currency_id': 1,
                'journ_date': this.newInvoice.inv_date,
                'journ_reference_number': this.newInvoice.inv_ref_no,
                'journ_notes': this.newInvoice.inv_customer_notes,
                'journ_total_amount': this.newInvoice.inv_total_amount,
                'corp_id': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this),
                'encoded_by': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getAuthenticatedUser(this)
            };

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', salesJournal).then(function (response) {

                alert('journal id is' + response.data.data.journ_id);
                alert('Journal has been created !');
                // this.$router.push({path : '/invoices' })
                return vm.createSalesJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createInventoryJournal: function createInventoryJournal() {
            ...
            var inventoryJournal = {

                'currency_id': 1,
                'journ_date': this.newInvoice.inv_date,
                'journ_reference_number': this.newInvoice.inv_ref_no,
                'journ_notes': this.newInvoice.inv_customer_notes,
                'journ_total_amount': this.merchandiseInventoryAmount,
                'corp_id': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this),
                'encoded_by': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getAuthenticatedUser(this)
            };
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', inventoryJournal).then(function (response) {

                alert('journal id is' + response.data.data.journ_id);
                alert('Journal has been created !');
                // this.$router.push({path : '/invoices' })
                return vm.createInventoryJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createSalesJournalEntries: function createSalesJournalEntries(journalId) {
            var salesEntries = [
            // output tax
            {
                ...
                tax_id: 1,
                contact_id: this.newInvoice.contact_id,
                entry_debit: 0.00,
                entry_credit: this.taxTotal,
                entry_desc: 'Output tax',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }, {
                acct_id: 11, // sales account id
                journal_id: journalId,
                tax_id: 1,
                contact_id: this.newInvoice.contact_id,
                entry_debit: 0.00,
                entry_credit: this.subTotal,
                entry_desc: 'Sales',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }, {
                ...
                tax_id: 1,
                contact_id: this.newInvoice.contact_id,
                entry_debit: this.grandTotal,
                entry_credit: 0.00,
                entry_desc: 'Accounts Receivable',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }, {
                acct_id: 15, // sales discount id
                journal_id: journalId,
                tax_id: 1,
                contact_id: this.newInvoice.contact_id,
                entry_debit: this.discountedAmount,
                entry_credit: 0.00,
                entry_desc: 'Sales Discount',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }];

            this.formIsSubmitted = true;
            this.storeEntries(salesEntries, journalId);
        ...
        createInventoryJournalEntries: function createInventoryJournalEntries(journalId) {
            var inventoryEntries = [{
                ...
                tax_id: 1,
                contact_id: this.newInvoice.contact_id,
                entry_debit: this.merchandiseInventoryAmount,
                entry_credit: 0.00,
                ...
                contact_id: this.newInvoice.contact_id,
                entry_debit: 0.00,
                entry_credit: this.merchandiseInventoryAmount,
                entry_desc: 'Merchandise Inventory',
                cost_center_id: __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this)
            }];

            this.storeEntries(inventoryEntries, journalId);
            alert('Sales invoice has been created !');
            this.$router.push({ path: '/invoices' });
        },
        storeEntries: function storeEntries(entries, journalId) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journal-entries/create', { journal_entries: entries, journal_id: journalId }).then(function (response) {
                ...
                // this.$router.push({path : '/sales-orders' })
            }, function (response) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(" SO-" + _vm._s(_vm.salesOrder.so_no) + " >  New Invoice ")])]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.loading),
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.so_contact_company_name),
      expression: "salesOrder.so_contact_company_name "
    }],
    ...
    on: {
      "change": function($event) {
        ...
        _vm.salesOrder.so_contact_company_name = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.whouse_id),
      expression: "salesOrder.whouse_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "50%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.salesOrder.whouse_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("\n                                     " + _vm._s(_vm.salesOrderItems[0].whouse_name) + "\n                                ")])])]) : _vm._e(), _vm._v(" "), _c('label', {
    staticClass: "col-md-2 control-label required-field"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.sales_person_id),
      expression: "salesOrder.sales_person_id"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "50%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.salesOrder.sales_person_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.so_ref_no),
      expression: "salesOrder.so_ref_no"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.salesOrder.so_ref_no = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.so_order_no),
      expression: "salesOrder.so_order_no"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "disabled": "disabled",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.salesOrder.so_order_no = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Invoice Date")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.so_order_date),
      expression: "salesOrder.so_order_date"
    }],
    staticClass: "form-control m-b ",
    attrs: {
      "type": "date"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.salesOrder.so_order_date = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.so_payment_terms),
      expression: "salesOrder.so_payment_terms"
    }],
    staticClass: "form-control",
    staticStyle: {
      "width": "50%"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.salesOrder.so_payment_terms = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
      "selected": "salesOrder.so_payment_terms == 'Due On Receipt' ",
      "value": "Due On Receipt"
    }
  }, [_vm._v("Due On Receipt")]), _vm._v(" "), _c('option', {
    attrs: {
      "selected": "salesOrder.so_payment_terms == 'Net 15' ",
      "value": "Net 15"
    }
  }, [_vm._v("Net 15")]), _vm._v(" "), _c('option', {
    attrs: {
      "selected": "salesOrder.so_payment_terms == 'Net 30' ",
      "value": "Net 30"
    }
  }, [_vm._v("Net 30")]), _vm._v(" "), _c('option', {
    attrs: {
      "selected": "salesOrder.so_payment_terms == 'Net 45' ",
      "value": "Net 45"
    }
  }, [_vm._v("Net 45")]), _vm._v(" "), _c('option', {
    attrs: {
      "selected": "salesOrder.so_payment_terms == 'Net 60' ",
      "value": "Net 60"
    }
  }, [_vm._v("Net 60")]), _vm._v(" "), _c('option', {
    attrs: {
      "selected": "salesOrder.so_payment_terms == 'End of Month' ",
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.so_due_date),
      expression: "salesOrder.so_due_date"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "date"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.salesOrder.so_due_date = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
  ...
  }, [_vm._m(0), _vm._v(" "), _c('tbody', _vm._l((_vm.salesOrderItems), function(item, index) {
    return _c('tr', {
      key: item
    }, [_c('td', [_c('select', {
      directives: [{
      ...
      on: {
        "change": function($event) {
          ...
          item.item_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
        }
      }
    }, [_c('option', {
      attrs: {
    ...
    }, [_vm._v("\n                                        " + _vm._s(item.item_name) + " \n                                    ")])])]), _vm._v(" "), _c('td', [_vm._v("\n                                 " + _vm._s(item.so_item_qty) + "\n                            ")]), _vm._v(" "), _c('td', [_vm._v("\n                                 " + _vm._s(item.so_item_qty) + "\n                            ")]), _vm._v(" "), _c('td', [_vm._v(" \n                               PHP " + _vm._s(item.so_item_rate) + "\n                            ")]), _vm._v(" "), _c('td', [_vm._v("\n                                PHP " + _vm._s(item.so_item_qty * item.so_item_rate) + "\n                            ")])])
  ...
  }, [_vm._v("Sales Discount (" + _vm._s(_vm.salesOrder.so_discount_percentage) + "%)")]), _vm._v(" "), _c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "2"
    }
  }, [_vm._v("\n                                " + _vm._s(_vm.salesOrder.so_discounted_amount) + "\n                            ")])]), _vm._v(" "), _c('tr', [_c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "4"
    }
  ...
  }, [_vm._v("\n                                " + _vm._s(Number(_vm.grandTotal * .89285714285).toFixed(2)) + "\n                            ")])]), _vm._v(" "), _c('tr', [_c('td', {
    staticClass: "text-right",
    attrs: {
      "colspan": "4"
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.salesOrder.so_customer_notes),
      expression: "salesOrder.so_customer_notes"
    }],
    staticClass: "form-control",
    attrs: {
      "rows": "2"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.salesOrder.so_customer_notes = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
  ...
  }, [_vm._v("Item Details")]), _vm._v(" "), _c('th', [_vm._v("Ordered")]), _vm._v(" "), _c('th', [_vm._v("Invoiced")]), _vm._v(" "), _c('th', {
    attrs: {
      "width": "15%"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b7b0019a", module.exports)
  }
}
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Sales Orders\\AddSalesOrderInvoice.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddSalesOrderInvoice.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b7b0019a", Component.options)
  } else {
    hotAPI.reload("data-v-b7b0019a", Component.options)
  }
})()}
