...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        ...
        subTotal: function subTotal() {
            ...
            var total = this.newInvoice.subTotal;
    ...
    methods: {
        ...
        createJournal: function createJournal() {
            ...
            var journal = {
                ...
                'encoded_by': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getAuthenticatedUser()
            };
        ...
        addInvoice: function addInvoice() {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoices/create', this.newInvoice).then(function (response) {
                ...
                console.log(response.data);
                return _this5.createJournal(response.data);
            }, function (response) {
                this.error = response.statusText;
        ...
        // addInvoicedItems(data){

        //     console.log(this.rows)

        //     this.$http.post(auth.app.API_URL+'/invoice-items/create',{ rows : this.rows, inv_id : data.inv_id } ).then((response) => {
        ...
        fetchContacts: function fetchContacts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/contacts').then(function (response) {
                console.log(response.statusText);
                _this7.$set(_this7, 'contacts', response.data);
            });
        },
        fetchSalesPersons: function fetchSalesPersons() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/salespersons').then(function (response) {
                console.log(response.statusText);
                _this8.$set(_this8, 'salespersons', response.data);
            });
        },
        fetchAccounts: function fetchAccounts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/accounts').then(function (response) {
                console.log(response.statusText);
                _this9.$set(_this9, 'accounts', response.data);
            });
        },
        fetchTaxes: function fetchTaxes() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/taxes').then(function (response) {
                console.log(response.statusText);
                _this10.$set(_this10, 'taxes', response.data);
            });
        },
        fetchWarehouses: function fetchWarehouses() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/warehouses').then(function (response) {
                console.log(response.statusText);
                _this11.$set(_this11, 'warehouses', response.data);
            });
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("New Migrated Invoice")])]), _vm._v(" "), (_vm.errors.length != 0) ? _c('div', {
    ref: "formErrors",
    staticClass: "alert",
    staticStyle: {
      "background": "#f0f0f0"
    ...
    staticClass: "col-md-5 control-label required-field"
  }, [_vm._v(" Total Amount (excl. tax and discounts  ) ")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newInvoice.subTotal),
      expression: "newInvoice.subTotal"
    }],
    staticClass: "form-control m-b ",
    domProps: {
      "value": (_vm.newInvoice.subTotal)
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newInvoice.subTotal = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-5 control-label required-field"
  }, [_vm._v(" Discount Percentage ")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    staticClass: "col-md-5 control-label required-field"
  }, [_vm._v(" Discount Amount ")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newInvoice.inv_discounted_amount),
      expression: "newInvoice.inv_discounted_amount"
    }],
    staticClass: "form-control m-b ",
    attrs: {
      "disabled": "disabled"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newInvoice.inv_discounted_amount = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "col-md-5 control-label required-field"
  }, [_vm._v(" Balance Due ")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newInvoice.inv_balance_amount),
      expression: "newInvoice.inv_balance_amount"
    }],
    staticClass: "form-control m-b ",
    domProps: {
      "value": (_vm.newInvoice.inv_balance_amount)
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newInvoice.inv_balance_amount = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('table', {
    staticClass: "table"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6db8f622", module.exports)
  }
}
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\Invoices\\AddMigratedInvoice.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddMigratedInvoice.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6db8f622", Component.options)
  } else {
    hotAPI.reload("data-v-6db8f622", Component.options)
  }
})()}
