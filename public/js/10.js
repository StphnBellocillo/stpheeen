...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            debitAmountTotal: 0.00,
            debitAndCreditAreNotEqual: false
    ...
    computed: {
        grandTotal: function grandTotal() {
            ...
            this.total = 0.00;
            this.creditAmountTotal = 0.00;
            this.debitAmountTotal = 0.00;
            // sum all the credit amounts
            this.rows.forEach(function (row) {
                return _this.creditAmountTotal += parseFloat(row.credit_amount);
            });
            // sum all the debit amounts
            this.rows.forEach(function (row) {
                return _this.debitAmountTotal += parseFloat(row.debit_amount);
            });
            this.total = this.debitAmountTotal;
            this.newDocumentMemorandum.memo_total_amount = this.total;
            this.newDocumentMemorandum.memo_balance_amount = this.total;

            if (this.debitAmountTotal != this.creditAmountTotal) {
                this.debitAndCreditAreNotEqual = true;
                return this.total;
            }
            this.debitAndCreditAreNotEqual = false;
            return this.total;
        }
    },
    ...
    methods: {
        ...
        changed: function changed(index) {
            ...
            this.accounts.forEach(function (account) {
                vm.suggestions.push(account);
            });
        },
        populateRowEntry: function populateRowEntry(index) {

            var vm = this;
            var queryResult = linq.from(this.accounts).where(function (account) {
                return account.acct_name == vm.rows[index].acct_name;
            }).toArray();
            console.log("query result " + JSON.stringify(queryResult));

            // populate the account id
            this.rows[index].acct_id = queryResult[0].acct_id;
            // populate the account name
        },
        addDocumentMemorandum: function addDocumentMemorandum() {
            var _this2 = this;

            this.newDocumentMemorandum.corp_id = __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this);
            this.formIsSubmitted = true;
            console.log(this.rows);
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/document-memorandums/create', this.newDocumentMemorandum).then(function (response) {

                console.log(response.data);
                return _this2.addDocumentMemorandumEntries(response.data);
        ...
        addDocumentMemorandumEntries: function addDocumentMemorandumEntries(data) {
            var _this3 = this;

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/document-memorandum-entries/create', { document_memo_id: data.document_memo_id, rows: this.rows }).then(function (response) {

                console.log(response.data);
                return _this3.createJournalEntry();
                // alert("Document Memo has been created !")
                _this3.$router.push({ path: '/document-memorandums' });
            }, function (response) {
                this.error = response.data.msg;
            });
        },
        fetchInvoices: function fetchInvoices() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoices').then(function (response) {
                ...
                _this4.$set(_this4, 'invoices', response.data);
            });
        },
        fetchAccounts: function fetchAccounts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/accounts').then(function (response) {
        ...
        fetchContacts: function fetchContacts() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/contacts').then(function (response) {
                _this6.$set(_this6, 'contacts', response.data);
                _this6.stopLoadingPlease();
            }, function (response) {
        ...
        createJournalEntry: function createJournalEntry() {
            ...
            this.saveText = '<i class="fa fa-spinner fa-spin"></i> Creating Journal ';
            var journal = {

                'currency_id': 1,
                'journ_date': this.newDocumentMemorandum.memo_date,
                'journ_reference_number': this.newDocumentMemorandum.memo_ref_no,
                'journ_notes': this.newDocumentMemorandum.memo_notes,
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                return _this7.createJournalEntries(response.data.data.journ_id);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createJournalEntries: function createJournalEntries(journalId) {
            this.saveText = '<i class="fa fa-spinner fa-spin"></i> Creating Journal Entries... ';
            var entries = [];
            var vm = this;
            this.rows.map(function (entry, index) {
                var entry = {
                    acct_id: entry.acct_id,
                    journal_id: journalId,
                    tax_id: 1,
                    contact_id: vm.newDocumentMemorandum.contact_id,
                    entry_debit: entry.debit_amount,
                    entry_credit: entry.credit_amount,
            ...
            alert("Document Memo has been created !");
            this.$router.push({ path: '/document-memorandums' });
        },
...
Component.options.__file = "C:\\Users\\probitousxx\\Code\\projects\\nepan-inventory\\resources\\assets\\js\\components\\DocumentMemorandums\\AddDocumentMemorandum.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AddDocumentMemorandum.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-09078a50", Component.options)
  } else {
    hotAPI.reload("data-v-09078a50", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(" New Document Memorandum ")])]), _vm._v(" "), (_vm.error) ? _c('div', {
    ref: "formErrors",
    staticClass: "alert",
    staticStyle: {
      "background": "#f0f0f0"
  ...
  }, [_vm._v("Memo Type")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newDocumentMemorandum.memo_type),
      expression: "newDocumentMemorandum.memo_type"
    }],
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newDocumentMemorandum.memo_type = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', {
    attrs: {
  ...
  }, [_vm._v("Credit Note ")])])])]), _vm._v(" "), (_vm.newDocumentMemorandum.memo_type == 'Credit Note') ? _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
    staticClass: "col-md-2 control-label required-field"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newDocumentMemorandum.inv_id),
      expression: "newDocumentMemorandum.inv_id"
    }],
    staticClass: "form-control",
    on: {
      "change": function($event) {
        ...
        _vm.newDocumentMemorandum.inv_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newDocumentMemorandum.memo_ref_no),
      expression: "newDocumentMemorandum.memo_ref_no"
    }],
    ...
    on: {
      "input": function($event) {
        ...
        _vm.newDocumentMemorandum.memo_ref_no = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newDocumentMemorandum.contact_id),
      expression: "newDocumentMemorandum.contact_id"
    }],
    staticClass: "form-control",
    attrs: {
      "required": "required"
    ...
    on: {
      "change": function($event) {
        ...
        _vm.newDocumentMemorandum.contact_id = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
    ...
    staticClass: "col-md-2 control-label required-field"
  }, [_vm._v("Memo Date")]), _vm._v(" "), _c('div', {
    staticClass: "col-md-5"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newDocumentMemorandum.memo_date),
      expression: "newDocumentMemorandum.memo_date"
    }],
    staticClass: "form-control m-b",
    attrs: {
      "type": "date"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newDocumentMemorandum.memo_date = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "plain"
  }, [(_vm.debitAmountTotal != _vm.creditAmountTotal) ? _c('div', {
  ...
  }, [_vm._v("×")]), _vm._v(" "), _c('strong', [_vm._v("Oh crap !")]), _vm._v(" Debit and credit are not equal\n                ")]) : _vm._e(), _vm._v(" "), _c('table', {
    ...
    return _c('tr', {
      ...
      model: {
        ...
        expression: "row.acct_name"
      }
    }), _vm._v(" "), _c('hr')], 1), _vm._v(" "), _c('td', {
      attrs: {
        "width": "15%"
      }
    }, [_c('input', {
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          row.debit_amount = $event.target.value
        },
        "blur": function($event) {
          _vm.$forceUpdate()
        }
      ...
      on: {
        "input": function($event) {
          if ($event.target.composing) { return; }
          row.credit_amount = $event.target.value
        },
        "blur": function($event) {
          _vm.$forceUpdate()
        }
  ...
  }), _vm._v(" "), _c('tr', [_c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _c('td'), _vm._v(" "), _vm._m(3), _vm._v(" "), _c('td', [_c('strong', [_vm._v(" " + _vm._s(_vm._f("currency")(_vm.grandTotal, '', 2)) + " ")])])])], 2)]), _vm._v(" "), _c('a', {
    staticClass: "btn btn-default",
    on: {
      "click": function($event) {
        _vm.addRow()
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.newDocumentMemorandum.memo_notes),
      expression: "newDocumentMemorandum.memo_notes"
    }],
    staticClass: "form-control",
    attrs: {
      "rows": "2"
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.newDocumentMemorandum.memo_notes = $event.target.value
      }
    }
  })])])]), _vm._v(" "), _c('div', {
    staticClass: "row"
    ...
    attrs: {
      "disabled": _vm.formIsSubmitted || _vm.debitAndCreditAreNotEqual,
      "type": "button"
    },
    on: {
      "click": function($event) {
        _vm.addDocumentMemorandum()
      }
    }
  ...
  return _c('thead', [_c('tr', [_c('th', [_vm._v("Account")]), _vm._v(" "), _c('th', [_vm._v("Debit")]), _vm._v(" "), _c('th', [_vm._v("Credit")]), _vm._v(" "), _c('th', [_vm._v("Description")]), _vm._v(" "), _c('th')])])
},function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-09078a50", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("066c1fc0", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-09078a50\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddDocumentMemorandum.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-09078a50\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddDocumentMemorandum.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
