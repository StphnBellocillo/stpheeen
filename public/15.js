...
var update = __webpack_require__(8)("40f0ff28", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-24246f2f\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PrintInvoice.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-24246f2f\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./PrintInvoice.vue");
  ...
  return _c("div", { staticClass: "row" }, [
    ...
    _c(
      "div",
      {
        ...
        staticStyle: { "z-index": "99", position: "relative" }
      },
      [
        _c("div", {}, [
          _c(
            ...
            [_c("strong", [_vm._v(" " + _vm._s(_vm.invoice.inv_no) + " ")])]
          ),
          _vm._v(" "),
          _c(
            "p",
            ...
            [_vm._v(_vm._s(_vm.invoice.inv_date))]
          ),
          _vm._v(" "),
          _c(
            "p",
            ...
            [
              _vm._v(
                _vm._s(_vm._f("currency")(_vm.invoice.inv_total_amount, "", 2))
              )
            ]
          ),
          _vm._v(" "),
              ...
              ? _c(
                  ...
                  [
                    _c("strong", [
                      _vm._v(
                        "\n                    " +
                          _vm._s(_vm.invoiceItems[0].contact_street) +
                          ", " +
                ...
                ? _c(
                    ...
                    [
                      _c("strong", [
                        _vm._v(
                          "\n                   " +
                            _vm._s(_vm.invoice.inv_payment_terms)
                        )
                      ])
                    ]
                  )
          ...
          _c("div", { staticClass: "pull-right" }, [
            _c(
              ...
              [
                _vm._v(
                  " " +
                    _vm._s(_vm.invoiceItems[0].contact_tin_no) +
                    " \n                     "
                )
              ]
            )
                          ...
                          [
                            _vm._v(
                              "\n                                " +
                                _vm._s(
                                  _vm._f("currency")(
                                    item.inv_item_rate * item.conversion_qty,
                                    "",
                                    2
                                  )
                                ) +
                  ...
                  _c("tr", [
                    ...
                    _c("td", { attrs: { colspan: "2" } }, [
                      _vm._v(
                        " S.D " +
                          _vm._s(
                            _vm.invoice.inv_discount_percentage == _vm.NULL
                              ? 0
                              : _vm.invoice.inv_discount_percentage
                          ) +
                          "% "
                      )
                    ]),
                      ...
                      [
                        _vm._v(
                          " " +
                            _vm._s(
                              _vm._f("currency")(
                                _vm.invoice.inv_discounted_amount,
                                "",
                                2
                              )
                            ) +
                      ...
                      [
                        _vm._v(
                          "  " +
                            _vm._s(
                              _vm._f("currency")(
                                _vm.invoice.inv_total_amount * 0.10714285714,
                                "",
                                2
                              )
                            ) +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-24246f2f", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Invoices\\PrintInvoice.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-24246f2f", Component.options)
  } else {
    hotAPI.reload("data-v-24246f2f", Component.options)
  }
