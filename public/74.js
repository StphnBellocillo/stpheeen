  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "page-title" }, [
                    ...
                    "router-link",
                    {
                      attrs: {
                        to: {
                          ...
                          query: { contact_id: _vm.contact_id }
                        }
                      }
                    },
                    [_vm._v("Sales Order")]
      ...
      _c("div", { staticClass: "title" }, [
        _vm._v("\n          " + _vm._s(_vm.contact.contact_company_name)),
        _c("br")
      ])
    ]),
    _vm._v(" "),
    ...
    _c(
      ...
      [
        ...
        _c("div", { staticClass: "col-md-3" }, [
          _c("strong", [_vm._v("Address Information")]),
          _vm._v(" "),
          _c("table", { staticClass: "table" }, [
            _c("tbody", [
              _c("tr", [
                _c("td", [_vm._v(" City  ")]),
                _vm._v(" "),
                _c("td", [_vm._v(" " + _vm._s(_vm.contact.contact_city) + " ")])
              ]),
              _vm._v(" "),
              _c("tr", [
                _c("td", [_vm._v(" Street ")]),
                _vm._v(" "),
                _c("td", [
                  _vm._v(" " + _vm._s(_vm.contact.contact_street) + " ")
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [
                  _vm._v(" " + _vm._s(_vm.contact.contact_country) + " ")
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [_vm._v(" " + _vm._s(_vm.contact.contact_zip) + " ")])
              ])
            ])
          ])
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "col-md-3" }, [
          _c("strong", [_vm._v("Company Information")]),
          _vm._v(" "),
          _c("table", { staticClass: "table" }, [
            _c("tbody", [
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [
                  _vm._v(" " + _vm._s(_vm.contact.contact_tin_no) + " ")
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                _c("td", [_vm._v(" Payment Terms ")]),
                _vm._v(" "),
                _c("td", [
                  _vm._v(" " + _vm._s(_vm.contact.contact_payment_terms) + " ")
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [
                  _vm._v(" " + _vm._s(_vm.contact.contact_district) + " ")
                ])
              ]),
              _vm._v(" "),
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [
                  _vm._v(" " + _vm._s(_vm.contact.contact_classification) + " ")
                ])
              ])
            ])
          ])
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "box-tab m-b-0" }, [
          _vm._m(3),
          _vm._v(" "),
          _c("div", { staticClass: "tab-content" }, [
            ...
            _c(
              "div",
              { staticClass: "tab-pane active", attrs: { id: "transactions" } },
              [
                _vm.contact.contact_type_id == 2
                          ...
                          _c(
                            ...
                            [
                              _vm.loading
                                ...
                                : _vm._e(),
                              _vm._v(" "),
                              _vm._l(_vm.invoices, function(transaction) {
                                return _vm.invoices.length != 0
                                  ? _c("tr", [
                                      _c("td", [
                                        _vm._v(
                                          " INV-" +
                                            _vm._s(transaction.inv_no) +
                                            " "
                                        )
                                      ]),
                                      _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _vm.loading
                                ...
                                : _vm._e(),
                              _vm._v(" "),
                              _vm._l(_vm.payments, function(transaction) {
                                return _vm.payments.length != 0
                                  ? _c("tr", [
                                      _c("td", [
                                        _vm._v(
                                          " " +
                                            _vm._s(transaction.payment_id) +
                                            " "
                                        )
                                      ]),
                                      _vm._v(" "),
                                      _c("td", [
                                        _vm._v(
                                          " " +
                                            _vm._s(transaction.payment_ref_no) +
                                            " "
                                        )
                                      ]),
                                      _vm._v(" "),
                                      _c("td", [
                                        _vm._v(
                                          " " +
                                            _vm._s(transaction.payment_mode) +
                                            " "
                                        )
                                      ]),
                                      _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _vm.loading
                                ...
                                : _vm._e(),
                              _vm._v(" "),
                              _vm._l(_vm.salesOrders, function(transaction) {
                                return _vm.salesOrders.length != 0
                                  ? _c("tr", [
                                      _c("td", [
                                        _vm._v(
                                          " SO-" +
                                            _vm._s(transaction.so_id) +
                                            " "
                                        )
                                      ]),
                                      _vm._v(" "),
                ...
                return _c("li", { staticClass: "list-group-item" }, [
                  ...
                  _vm._v(
                    "\n                                " +
                      ...
                      "  -  " +
                      _vm._s(Number(discount.discount_percentage).toFixed(0)) +
                      "%"
                  )
                ])
              })
    ...
    _c(
      "div",
      { staticClass: "modal fade", attrs: { id: "modal-add-discount" } },
      [
                  ...
                  return _c("li", [
                    _c("input", {
                      ...
                      domProps: {
                        ...
                        checked: Array.isArray(_vm.newDiscounts.discount_id)
                          ? _vm._i(
                              _vm.newDiscounts.discount_id,
                      ...
                      on: {
                        change: function($event) {
                          ...
                          if (Array.isArray($$a)) {
                            ...
                            if ($$el.checked) {
                              $$i < 0 &&
                                (_vm.newDiscounts.discount_id = $$a.concat([
                                  $$v
                                ]))
                            } else {
                              $$i > -1 &&
                                (_vm.newDiscounts.discount_id = $$a
                                  .slice(0, $$i)
                                  .concat($$a.slice($$i + 1)))
                            }
                          } else {
                            _vm.$set(_vm.newDiscounts, "discount_id", $$c)
                          }
                        }
                      }
                    }),
                      ...
                      _c("input", {
                        directives: [
                          {
                            ...
                            expression:
                              "newDiscounts.discount_percentage[index]"
                          }
                        ],
                        ...
                        on: {
                          input: function($event) {
                            ...
                            _vm.$set(
                              _vm.newDiscounts.discount_percentage,
                              index,
                              $event.target.value
                            )
                          }
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "col-md-3" }, [
      _c("img", {
        ...
        attrs: {
          src:
            "http://www.marinediscoverycenter.org/wp-content/uploads/2017/06/placeholder.png"
        }
      })
    ])
  },
  function() {
    ...
    return _c("ul", { staticClass: "nav nav-tabs" }, [
      _c("li", { staticClass: "active" }, [
        _c("a", { attrs: { href: "#transactions", "data-toggle": "tab" } }, [
          _vm._v("Transactions")
        ])
      ])
    ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "tab-pane", attrs: { id: "defaults" } }, [
      _c("h3", [_vm._v("Transaction Defaults")]),
      _vm._v(" "),
      _c("p", [_vm._v(" Payment Terms : Due on Receipt ")]),
      _vm._v(" "),
      _c("p", [_vm._v("Discounts")]),
      _c("hr"),
      _vm._v(" "),
      _c("ul", [
        _c("li", [_vm._v(" PHP500 on Sales Order ")]),
        _vm._v(" "),
        _c("li", [_vm._v(" PHP900 on Purchase Orders ")])
      ])
    ])
  },
  function() {
  ...
  function() {
    ...
    return _c("div", { staticClass: "panel-heading" }, [
      _c("h3", { staticClass: "panel-title" }, [_vm._v("TRANSACTION DEFAULTS")])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c(
      "a",
      { attrs: { "data-toggle": "modal", href: "#modal-add-discount" } },
      [_c("i", { staticClass: "fa fa-plus" }), _vm._v(" Add Discounts")]
    )
  },
  function() {
    var _vm = this
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-062212ee", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Contacts\\ViewContact.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-062212ee", Component.options)
  } else {
    hotAPI.reload("data-v-062212ee", Component.options)
  }
