...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        addPurchaseReturn: function addPurchaseReturn() {
            ...
            this.newPurchaseReturn.contact_id = this.purchaseOrderItems[0].contact_id;
            this.newPurchaseReturn.whouse_id = this.purchaseOrder.whouse_id;
            this.newPurchaseReturn.account_id = 808;
        ...
        addPurchaseReturnItems: function addPurchaseReturnItems(data) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth__["a" /* default */].app.API_URL + '/purchase-return-items/create', { rows: purchaseReturnItems, new_purchase_return: this.newPurchaseReturn }).then(function (response) {

                console.log("RETURN ID : " + response.data.purchase_return.purchase_rturn_id);
                _this2.loading = false;
                alert("Purchase Return has been created !");
                _this2.$router.push({ path: '/purchase-returns/' + response.data.purchase_return.purchase_rturn_id });
            }, function (response) {
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "title" }, [
          _vm._v(_vm._s(_vm.poNumber) + " / New Purchase Return ")
        ])
      ]
    ),
    _vm._v(" "),
                ...
                _c("input", {
                  ...
                  on: {
                    input: function($event) {
                      ...
                      _vm.$set(
                        _vm.newPurchaseReturn,
                        "purchase_rturn_ref_no",
                        $event.target.value
                      )
                    }
                  }
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c(
                  ...
                  [
                    _vm.purchaseOrderItems[0].contact_id
                      ? _c(
                          "option",
                          {
                            attrs: { selected: "" },
                            domProps: {
                              value: _vm.purchaseOrderItems[0].contact_id
                            }
                          },
                          [
                            _vm._v(
                              " " +
                                _vm._s(
                                  _vm.purchaseOrderItems[0].contact_company_name
                                ) +
                                " "
                            )
                          ]
                    ...
                    return _c("tr", [
                      ...
                      _c("td", [
                        _vm._v(
                          "\n                                     " +
                            _vm._s(
                              parseInt(row.purchse_order_item_qty) -
                                parseInt(
                                  _vm.prItems[index]
                                    .purchase_rcvd_item_qty_received
                                )
                  ...
                  _c("tr", [
                    ...
                    _c("td", [
                      _vm._v(
                        " " +
                          _vm._s(
                            _vm._f("currency")(_vm.discountedAmount, "PHP", 2)
                          )
                      )
                    ])
                  ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3364e89e", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\PurchaseReturns\\AddPurchaseReturn.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3364e89e", Component.options)
  } else {
    hotAPI.reload("data-v-3364e89e", Component.options)
  }
