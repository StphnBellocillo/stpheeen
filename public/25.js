...
/* harmony default export */ __webpack_exports__["default"] = ({
    mounted: function mounted() {
        ...
        this.newInvoice.inv_order_no = this.$route.query.order_number;
    ...
    computed: {
        ...
        subTotal: function subTotal() {
            ...
            var total = 0;
            this.rows.forEach(function (row) {
                return total += parseInt(row.inv_item_qty) * parseFloat(row.inv_item_rate);
            });
        ...
        grandTotal: function grandTotal() {
            ...
            var grandTotal = 0;
            this.rows.forEach(function (row) {
                return _this2.total = (_this2.subTotal - _this2.newInvoice.inv_discounted_amount) * 1.12;
            });
    ...
    methods: {
        findItemRate: function findItemRate(itemId, index) {
            var queryResult = linq.from(this.items).where(function (item) {
                return item.item_id == itemId;
            }).toArray();

            // populate the item rate
            this.rows[index].inv_item_rate = queryResult[0].retail_price;
            this.rows[index].inv_item_qty = 1;
        ...
        findAccountName: function findAccountName(item, index) {
            ...
            this.rows[index].account_id = item.sales_info_id;
            this.rows[index].currentItemAccountId = item.sales_info_id;
        ...
        createJournal: function createJournal() {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                _this3.createJournalEntries(response.data.data.journ_id);
            }, function (response) {
        ...
        createJournalEntries: function createJournalEntries(journalId) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journal-entries/create', { journal_entries: entries, journal_id: journalId }).then(function (response) {
                ...
                _this4.$router.push({ path: '/invoices' });
            }, function (response) {
        ...
        addInvoice: function addInvoice() {
            ...
            this.newInvoice.corp_id = __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getCorporationId(this);
            this.formIsSubmitted = true;
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoices/create', this.newInvoice).then(function (response) {
                // alert(response.data.inv_id)
                console.log(response.data);

                return _this5.addInvoicedItems(response.data);
            }, function (response) {
                this.error = response.statusText;
        ...
        addInvoicedItems: function addInvoicedItems(data) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/invoice-items/create', { rows: this.rows, inv_id: data.inv_id }).then(function (response) {

                console.log(response.data);
                return _this6.createJournal();
            }, function (response) {
        ...
        fetchSalesPersons: function fetchSalesPersons() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/salespersons').then(function (response) {
                console.log(response.statusText);
                _this9.$set(_this9, 'salespersons', response.data);
            });
        },
        ...
        fetchTaxes: function fetchTaxes() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/taxes').then(function (response) {
                console.log(response.statusText);
                _this11.$set(_this11, 'taxes', response.data);
            });
        },
        fetchWarehouses: function fetchWarehouses() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/warehouses').then(function (response) {
                console.log(response.statusText);
                _this12.$set(_this12, 'warehouses', response.data);
            });
        },
        ...
        addRow: function addRow(index) {
            ...
            this.rows.splice(index + 1, 0, { item_id: null, account_id: null, tax_id: null, inv_item_rate: null, inv_item_qty: null, tax_amount: '0.00', row_total_amount: 0.00 });
        },
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "page-title" }, [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "title" }, [_vm._v("New Invoice")])
    ]),
    _vm._v(" "),
    _vm.errors.length != 0
      ? _c(
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.newInvoice.contact_id,
                            expression: "newInvoice.contact_id"
                          }
                        ],
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.newInvoice.whouse_id,
                            expression: "newInvoice.whouse_id"
                          }
                        ],
                        staticClass: "form-control",
                        staticStyle: { width: "50%" },
                      ...
                      _c(
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.newInvoice.sales_person_id,
                              expression: "newInvoice.sales_person_id"
                            }
                          ],
                          staticClass: "form-control",
                          staticStyle: { width: "50%" },
                        ...
                        _vm._l(_vm.salespersons, function(salesperson) {
                          return _c(
                            ...
                            [
                              _vm._v(
                                " " + _vm._s(salesperson.display_name) + " "
                              )
                            ]
                          )
                        })
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.newInvoice.inv_ref_no,
                      expression: "newInvoice.inv_ref_no"
                    }
                  ],
                  staticClass: "form-control m-b",
                  attrs: { type: "text" },
                  domProps: { value: _vm.newInvoice.inv_ref_no },
                  on: {
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.newInvoice.inv_order_no,
                      expression: "newInvoice.inv_order_no"
                    }
                  ],
                  staticClass: "form-control m-b",
                  attrs: { type: "text" },
                  domProps: { value: _vm.newInvoice.inv_order_no },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.newInvoice.inv_date,
                      expression: "newInvoice.inv_date"
                    }
                  ],
                  staticClass: "form-control m-b ",
                  attrs: { "data-": "", type: "date" },
                  domProps: { value: _vm.newInvoice.inv_date },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.newInvoice, "inv_date", $event.target.value)
                    }
                  }
                })
              ])
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("div", { staticClass: "m-b" }, [
                  _c(
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.newInvoice.inv_payment_terms,
                          expression: "newInvoice.inv_payment_terms"
                        }
                      ],
                      staticClass: "form-control",
                      staticStyle: { width: "50%" },
                    ...
                    [
                      _c("option", { attrs: { value: "Due On Receipt" } }, [
                        _vm._v("Due On Receipt")
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "Net 15" } }, [
                        _vm._v("Net 15")
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "Net 30" } }, [
                        _vm._v("Net 30")
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "Net 45" } }, [
                        _vm._v("Net 45")
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "Net 60" } }, [
                        _vm._v("Net 60")
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "End of Next Month" } }, [
                  ...
                  directives: [
                    {
                      name: "model",
                      rawName: "v-model",
                      value: _vm.newInvoice.inv_due_date,
                      expression: "newInvoice.inv_due_date"
                    }
                  ],
                  staticClass: "form-control m-b",
                  attrs: { type: "date" },
                  domProps: { value: _vm.newInvoice.inv_due_date },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
            ...
            _c("div", { staticClass: "checkbox" }, [
              _c("label", [
                _c("input", {
                  ...
                  attrs: { type: "checkbox" },
                  domProps: {
                    checked: Array.isArray(_vm.isDiscountedSales)
                      ? _vm._i(_vm.isDiscountedSales, null) > -1
                      : _vm.isDiscountedSales
                  },
                  on: {
                    change: function($event) {
                  ...
                  _c("div", { staticClass: "col-md-5" }, [
                    _c(
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.newInvoice.discountAccount,
                            expression: "newInvoice.discountAccount"
                          }
                        ],
                        staticClass: "form-control",
                        staticStyle: { width: "50%" },
                      ...
                      [
                        _c(
                          "option",
                          { attrs: { selected: "" }, domProps: { value: 15 } },
                          [
                            _vm._v(
                              " \n                                Sales Discount\n                            "
                            )
            ...
            _c("div", { staticClass: "checkbox" }, [
              _c("label", [
                _c("input", {
                  ...
                  attrs: { type: "checkbox" },
                  domProps: {
                    checked: Array.isArray(_vm.isTaxableSales)
                      ? _vm._i(_vm.isTaxableSales, null) > -1
                      : _vm.isTaxableSales
                  },
                  on: {
                    change: function($event) {
                  ...
                  _c("div", { staticClass: "col-md-5" }, [
                    _c(
                      ...
                      [
                        _c(
                          "option",
                          { attrs: { selected: "" }, domProps: { value: 100 } },
                          [
                            _vm._v(
                              " \n                                Output Tax\n                            "
                            )
                ...
                _vm._l(_vm.rows, function(row, index) {
                  return _c("tr", { key: row }, [
                        ...
                        "select",
                        {
                          ...
                          on: {
                            change: [
                              ...
                              function($event) {
                                _vm.findItemRate(row.item_id, index)
                              }
                            ]
                          }
                        },
                    ...
                    _c("td", [
                      _c(
                        "select",
                        {
                          ...
                          attrs: {
                            title:
                              "Account selected during the creation of this item",
                            disabled: ""
                          },
                          on: {
                            change: function($event) {
                        ...
                        [
                          _c(
                            "option",
                            {
                              ...
                              domProps: { value: row.currentItemAccountId }
                            },
                            [
                              _vm._v(
                                "\n                                    " +
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: row.inv_item_qty,
                            expression: "row.inv_item_qty"
                          }
                        ],
                        staticClass: "form-control",
                        staticStyle: { "min-width": "100px !important" },
                        attrs: { type: "number" },
                        domProps: { value: row.inv_item_qty },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(row, "inv_item_qty", $event.target.value)
                          }
                        }
                      })
                    ]),
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: row.inv_item_rate,
                            expression: "row.inv_item_rate"
                          }
                        ],
                        staticClass: "form-control",
                        staticStyle: { "min-width": "100px !important" },
                        attrs: { type: "number" },
                        domProps: { value: row.inv_item_rate },
                        on: {
                          input: function($event) {
                            if ($event.target.composing) {
                              return
                            }
                            _vm.$set(row, "inv_item_rate", $event.target.value)
                          }
                        }
                      })
                    ]),
                    ...
                    _c("td", [
                      _vm._v(
                        "\n                                " +
                          _vm._s(row.inv_item_qty * row.inv_item_rate) +
                          "\n                            "
                      )
                    ]),
                    _vm._v(" "),
              ...
              _c("tfoot", [
                ...
                _vm.isDiscountedSales
                  ? _c("tr", [
                      ...
                      _c(
                        "td",
                        { staticClass: "text-right", attrs: { colspan: "1" } },
                        [
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.newInvoice.inv_discount_percentage,
                                expression: "newInvoice.inv_discount_percentage"
                              }
                            ],
                  ...
                  ? _c("tr", [
                      _c(
                        ...
                        [
                          _vm._v(
                            "Sales Discount ( " +
                              _vm._s(_vm.newInvoice.inv_discount_percentage) +
                              "% )"
                          )
                        ]
                      ),
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.newInvoice.inv_customer_notes,
                        expression: "newInvoice.inv_customer_notes"
                      }
                    ],
                    staticClass: "form-control",
                    attrs: { rows: "2" },
                    domProps: { value: _vm.newInvoice.inv_customer_notes },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { attrs: { width: "30%" } }, [_vm._v("Account")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e0911b0a", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Invoices\\AddInvoice.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e0911b0a", Component.options)
  } else {
    hotAPI.reload("data-v-e0911b0a", Component.options)
  }
