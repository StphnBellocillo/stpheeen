  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "page-title" }, [
      ...
      _c("div", { staticClass: "title" }, [
        _vm._v("GP-" + _vm._s(_vm.orderNumber) + " > CREATE SHIPMENT")
      ])
    ]),
    _vm._v(" "),
    _c(
          ...
          _c("div", { staticClass: "striped" }, [
              ...
              _c("div", { staticClass: "col-md-10" }, [
                _c(
                  "select",
                  {
                    ...
                    attrs: { disabled: "disabled", required: "required" },
                    on: {
                  ...
                  [
                    _c(
                      "option",
                      { domProps: { value: _vm.newShipment.gate_pass_id } },
                      [_vm._v(" GP-" + _vm._s(_vm.orderNumber) + " ")]
                    )
                  ]
                )
              ])
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  attrs: { type: "text" },
                  domProps: { value: _vm.newShipment.ship_order_no },
                  on: {
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  staticClass: "form-control m-b",
                  attrs: { type: "date" },
                  domProps: { value: _vm.newShipment.ship_date },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c(
                  ...
                  _vm._l(_vm.carriers, function(carrier) {
                    return _c(
                      "option",
                      { domProps: { value: carrier.carrier_id } },
                      [
                        _vm._v(
                          "\n                            " +
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  staticClass: "form-control m-b",
                  attrs: { type: "text" },
                  domProps: { value: _vm.newShipment.ship_tracking_no },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
            ...
            _c("div", { staticClass: "form-group" }, [
              _c("label", { staticClass: "col-md-2 control-label " }, [
                _vm._v("Shipping Charges(if any)")
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  staticClass: "form-control m-b",
                  attrs: { type: "text" },
                  domProps: { value: _vm.newShipment.ship_shipping_charges },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("textarea", {
                  ...
                  staticClass: "form-control",
                  attrs: { rows: "3" },
                  domProps: { value: _vm.newShipment.ship_notes },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
            ...
            _c("div", { staticClass: "container-action-bottom" }, [
              _c(
                "button",
                {
                  ...
                  attrs: { disabled: _vm.formIsSubmitted },
                  on: {
                    click: function($event) {
                      _vm.addNewShipment()
                    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-48db9d11", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Shipments\\AddShipment.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48db9d11", Component.options)
  } else {
    hotAPI.reload("data-v-48db9d11", Component.options)
  }
