...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "page-title" }, [
      _c(
        ...
        [
          _c(
            "router-link",
            { staticClass: "text-link", attrs: { to: "/items" } },
            [
              _c(
                "button",
      ...
      _vm._v(" "),
      _c("div", { staticClass: "title" }, [_vm._v("New Item")])
    ]),
    _vm._v(" "),
    _vm.errors.length != 0
      ? _c(
    ...
    _c("form", { staticClass: "form-horizontal", attrs: { role: "form" } }, [
      _c("div", { staticClass: "form-content" }, [
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("div", { staticClass: "col-md-5" }, [
              _c("input", {
                ...
                attrs: { type: "text" },
                domProps: { value: _vm.newItem.item_name },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.newItem, "item_name", $event.target.value)
                  }
                }
              })
            ])
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("div", { staticClass: "col-md-5" }, [
              _c("textarea", {
                ...
                attrs: { rows: "3" },
                domProps: { value: _vm.newItem.item_desc },
                on: {
                  input: function($event) {
                    if ($event.target.composing) {
                      return
                    }
                    _vm.$set(_vm.newItem, "item_desc", $event.target.value)
                  }
                }
              })
            ])
          ...
          _c("div", { staticClass: "form-group" }, [
            ...
            _c("div", { staticClass: "col-md-5" }, [
              _c("input", {
                ...
                staticClass: "form-control m-b",
                attrs: { type: "text" },
                domProps: { value: _vm.newItem.item_sku },
                on: {
                  ...
                  input: function($event) {
                    ...
                    _vm.$set(_vm.newItem, "item_sku", $event.target.value)
                  }
                }
              }),
              _vm._v(" "),
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c("div", { staticClass: "col-md-8" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control m-b",
                    attrs: { type: "text" },
                    domProps: { value: _vm.newItem.item_upc },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.newItem, "item_upc", $event.target.value)
                      }
                    }
                  })
                ])
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c("div", { staticClass: "col-md-8" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control m-b",
                    attrs: { type: "text" },
                    domProps: { value: _vm.newItem.item_mpn },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.newItem, "item_mpn", $event.target.value)
                      }
                    }
                  })
                ])
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c("div", { staticClass: "col-md-8" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control m-b",
                    attrs: { type: "text" },
                    domProps: { value: _vm.newItem.item_ean },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.newItem, "item_ean", $event.target.value)
                      }
                    }
                  })
                ])
              ...
              _c("div", { staticClass: "form-group" }, [
                ...
                _c("div", { staticClass: "col-md-8" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control m-b",
                    attrs: { type: "text" },
                    domProps: { value: _vm.newItem.item_isbn },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.newItem, "item_isbn", $event.target.value)
                      }
                    }
                  })
                ])
              ...
              _c("div", { staticClass: "checkbox" }, [
                _c("label", [
                  _c("input", {
                    ...
                    attrs: { type: "checkbox" },
                    domProps: {
                      checked: Array.isArray(_vm.isSaleable)
                        ? _vm._i(_vm.isSaleable, null) > -1
                        : _vm.isSaleable
                    },
                    on: {
                      change: function($event) {
              ...
              _vm.isSaleable
                ? _c("span", [
                          ...
                          _c(
                            ...
                            [
                              _c(
                                "option",
                                {
                                  attrs: { selected: "selected", value: "11" }
                                },
                                [_vm._v("Sales")]
                              )
                            ]
                    ...
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "col-md-offset-1 col-md-7" }, [
                        _c("textarea", {
                          directives: [
                            {
                              name: "model",
                          ...
                          staticClass: "form-control",
                          domProps: { value: _vm.newItemSalesInfo.description },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
              ...
              _c("div", { staticClass: "checkbox" }, [
                _c("label", [
                  _c("input", {
                    ...
                    attrs: { type: "checkbox" },
                    domProps: {
                      checked: Array.isArray(_vm.isPurchasable)
                        ? _vm._i(_vm.isPurchasable, null) > -1
                        : _vm.isPurchasable
                    },
                    on: {
                      change: function($event) {
              ...
              _vm.isPurchasable
                ? _c("span", [
                    _c("div", { staticClass: "form-group" }, [
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "col-md-offset-1 col-md-6" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
        ...
        _c("div", { staticClass: "plain" }, [
          _c("div", { staticClass: "row" }, [
            _c("div", { staticClass: "col-md-offset-1 col-md-8" }, [
              _c("h4", [_vm._v("Unit Conversion")]),
              _vm._v(
                "\n                    1 " + _vm._s(_vm.purchaseUnit) + " =  "
              ),
              _c("div", { staticClass: "input-group col-md-4" }, [
                _c("input", {
                  ...
                  domProps: { value: _vm.newItem.conversion_qty },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
        ...
        _vm._v(" "),
        _c("p", [
          _vm._v("Initial Stock will be updated in the Primary warehouse")
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "row" }, [
    ...
    _vm._v(" "),
    _c("div", { staticClass: "modal fade", attrs: { id: "modal-add-unit" } }, [
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { staticClass: "col-md-2 control-label" }, [
      _vm._v("UPC\n                            "),
      _c("i", {
        staticClass: "icon-question",
        attrs: {
          ...
          "data-placement": "top",
          title:
            "Twelve digit unique number associated with bar code (Universal Product Code)"
        }
      })
    ])
  },
  ...
  function() {
    ...
    return _c("div", { staticClass: "modal-header" }, [
      ...
      _vm._v(" "),
      _c("h4", { staticClass: "modal-title" }, [_vm._v("Add New Unit")])
    ])
  },
  function() {
    var _vm = this
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-13ac9531", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Items\\AddItem.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-13ac9531", Component.options)
  } else {
    hotAPI.reload("data-v-13ac9531", Component.options)
  }
