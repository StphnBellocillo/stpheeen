  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "page-title" }, [
      ...
      _c("div", { staticClass: "title" }, [
        _vm._v(" SO-" + _vm._s(_vm.salesOrder.so_no) + " >  New Invoice ")
      ])
    ]),
    _vm._v(" "),
    _c(
        ...
        _c("div", { staticClass: "form-content" }, [
                            ...
                            directives: [
                              {
                                ...
                                expression:
                                  "salesOrder.so_contact_company_name "
                              }
                            ],
                        ...
                        _c(
                          ...
                          [
                            _c(
                              ...
                              {
                                attrs: { selected: "selected" },
                                domProps: { value: _vm.salesOrder.whouse_id }
                              },
                              [
                                _vm._v(
                                  "\n                                     " +
                              ...
                              _c(
                                ...
                                [
                                  _vm._v(
                                    "\n                                         " +
                                      _vm._s(
                                        _vm.salesOrderItems[0].display_name
                                      ) +
                                      " \n                                    "
                                  )
                                ]
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  attrs: { type: "text" },
                  domProps: { value: _vm.salesOrder.so_ref_no },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                      }
                      _vm.$set(_vm.salesOrder, "so_ref_no", $event.target.value)
                    }
                  }
                })
              ])
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  domProps: { value: _vm.salesOrder.so_order_no },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  staticClass: "form-control m-b ",
                  attrs: { type: "date" },
                  domProps: { value: _vm.salesOrder.so_order_date },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
                    ...
                    [
                      _c(
                        "option",
                        {
                          attrs: {
                            selected:
                              "salesOrder.so_payment_terms == 'Due On Receipt' ",
                            value: "Due On Receipt"
                          }
                        },
                        [_vm._v("Due On Receipt")]
                      ),
                      _vm._v(" "),
                      _c(
                        "option",
                        {
                          attrs: {
                            selected:
                              "salesOrder.so_payment_terms == 'Net 15' ",
                            value: "Net 15"
                          }
                        },
                        [_vm._v("Net 15")]
                      ...
                      _c(
                        "option",
                        {
                          attrs: {
                            selected:
                              "salesOrder.so_payment_terms == 'Net 30' ",
                            value: "Net 30"
                          }
                        },
                        [_vm._v("Net 30")]
                      ...
                      _c(
                        "option",
                        {
                          attrs: {
                            selected:
                              "salesOrder.so_payment_terms == 'Net 45' ",
                            value: "Net 45"
                          }
                        },
                        [_vm._v("Net 45")]
                      ...
                      _c(
                        "option",
                        {
                          attrs: {
                            selected:
                              "salesOrder.so_payment_terms == 'Net 60' ",
                            value: "Net 60"
                          }
                        },
                        [_vm._v("Net 60")]
                      ...
                      _c(
                        "option",
                        {
                          attrs: {
                            selected:
                              "salesOrder.so_payment_terms == 'End of Month' ",
                            value: "End of Next Month"
                          }
                        },
                        [_vm._v("End of Next Month")]
                      )
                    ]
                  )
                ])
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("div", { staticClass: "col-md-5" }, [
                _c("input", {
                  ...
                  staticClass: "form-control m-b",
                  attrs: { type: "date" },
                  domProps: { value: _vm.salesOrder.so_due_date },
                  on: {
                    input: function($event) {
                      if ($event.target.composing) {
                        return
          ...
          _c("div", { staticClass: "plain" }, [
            _c("table", { staticClass: "table table-bordered" }, [
              ...
              _c(
                "tbody",
                _vm._l(_vm.salesOrderItems, function(item, index) {
                  return _c("tr", { key: item }, [
                    _c("td", [
                      _c(
                        "select",
                        {
                          ...
                          staticClass: "form-control",
                          staticStyle: { "min-width": "250px !important" },
                          on: {
                            change: function($event) {
                              var $$selectedVal = Array.prototype.filter
                                .call($event.target.options, function(o) {
                    ...
                    _c("td", [
                      _vm._v(
                        "\n                                PHP " +
                          _vm._s(item.so_item_qty * item.so_item_rate) +
                          "\n                            "
                      )
                    ])
                  ])
                ...
                _c("tr", [
                  _c(
                    ...
                    [
                      _vm._v(
                        "Sales Discount (" +
                          _vm._s(_vm.salesOrder.so_discount_percentage) +
                          "%)"
                      )
                    ]
                  ),
                  ...
                  _c(
                    ...
                    [
                      _vm._v(
                        "\n                                " +
                          _vm._s(
                            Number(_vm.grandTotal * 0.89285714285).toFixed(2)
                          ) +
                          "\n                            "
                      )
                    ]
              ...
              [
                ...
                _c("div", { staticClass: "col-md-5" }, [
                  _c("textarea", {
                    ...
                    staticClass: "form-control",
                    attrs: { rows: "2" },
                    domProps: { value: _vm.salesOrder.so_customer_notes },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { attrs: { width: "30%" } }, [_vm._v("Item Details")]),
        _vm._v(" "),
        _c("th", [_vm._v("Ordered")]),
        _vm._v(" "),
        _c("th", [_vm._v("Invoiced")]),
        _vm._v(" "),
        _c("th", { attrs: { width: "15%" } }, [_vm._v("Rate")]),
        _vm._v(" "),
        _c("th", { attrs: { width: "12%" } }, [_vm._v("TOTAL")])
      ])
    ])
  },
  function() {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-08975126", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Sales Orders\\AddSalesOrderInvoice.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-08975126", Component.options)
  } else {
    hotAPI.reload("data-v-08975126", Component.options)
  }
