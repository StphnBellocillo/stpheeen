...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchTransactions: function fetchTransactions(index) {
            ...
            //find the index
            var queryResult = linq.from(this.businesses).where(function (business) {
                return business.buss_name == vm.buss_name;
            }).toArray();

            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/reports/generate/per-principal/' + queryResult[0].buss_id).then(function (response) {
        ...
        changed: function changed() {
            ...
            this.businesses.forEach(function (salesperson) {
        ...
        fetchBusinesses: function fetchBusinesses() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/businesses').then(function (response) {
                console.log(response.statusText);
                _this2.$set(_this2, 'businesses', response.data);
            });
        },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-50b5dfa8", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\Reports\\ReportPerSKU.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-50b5dfa8", Component.options)
  } else {
    hotAPI.reload("data-v-50b5dfa8", Component.options)
  }
