...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(8)("ad82351a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-71e8b99c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddReturnMaterialReceipt.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-71e8b99c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AddReturnMaterialReceipt.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
    ...
    methods: {
        ...
        addReturnMaterialReceiptItems: function addReturnMaterialReceiptItems(data) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/return-material-receipt-items/create', { rows: this.rows }).then(function (response) {
                ...
                return _this2.recordTransactionDiscounts(response.data);
            }, function (response) {
                this.errors = response.data;
                this.formIsSubmitted = false;
            });
        ...
        recordTransactionDiscounts: function recordTransactionDiscounts(data) {
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/transaction-discounts/create', { contact_discounts: rmrTransactionDiscounts }).then(function (response) {
                ...
                return _this3.createCustomerPayableJournal(rmrTransactionDiscounts);
            }, function (response) {
        ...
        fetchSalesPersons: function fetchSalesPersons() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/salespersons').then(function (response) {
                ...
                _this5.$set(_this5, 'salespersons', response.data);
            });
        },
        fetchItemWithPurchasePrice: function fetchItemWithPurchasePrice() {
            ...
            this.$http.get(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.API_URL + '/items?type=purchase').then(function (response) {
                console.log(response.statusText);
                _this6.$set(_this6, 'itemsWithPurchasePrice', response.data);
            });
        },
        ...
        createCustomerPayableJournal: function createCustomerPayableJournal(rmrTransactionDiscounts) {
            var _this10 = this;
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                return _this10.createCustomerPayableJournalEntries(journal, rmrTransactionDiscounts);
            }, function (response) {
                this.error = response.statusText;
            });
        },
        createInventoryJournal: function createInventoryJournal(journal, rmrTransactionDiscounts) {
            var _this11 = this;
            ...
            var journal = {
                ...
                'encoded_by': __WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].getAuthenticatedUser(this),
                'payment': true,
                'customer_inventory_journal': true
            };
            ...
            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journals/create-from-inventory', journal).then(function (response) {
                ...
                return _this11.createInventoryJournalEntries(journal, rmrTransactionDiscounts);
            }, function (response) {
                this.formIsSubmitted = false;
                this.error = response.statusText;
            });
        },
        createInventoryJournalEntries: function createInventoryJournalEntries(journal, rmrTransactionDiscounts) {
            ...
            this.storeEntries(entries, journal, rmrTransactionDiscounts);
            alert("RMR has been created !");
            this.$router.push({ path: '/return-material-receipts' });
        },
        createCustomerPayableJournalEntries: function createCustomerPayableJournalEntries(journal, rmrTransactionDiscounts) {
            var entries = [{
        ...
        storeEntries: function storeEntries(entries, journal, rmrTransactionDiscounts) {

            this.formIsSubmitted = true;

            console.log(entries);

            this.$http.post(__WEBPACK_IMPORTED_MODULE_0__Auth_auth_js__["a" /* default */].app.COMPACCT_API_URL + '/journal-entries/create', { journal_entries: entries, journal: journal, contact_discounts: rmrTransactionDiscounts, rows: this.rows, new_rmr: this.newRMR }).then(function (response) {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "page-title" }, [
        ...
        [
          _c(
            "router-link",
            {
              ...
              attrs: { to: "/return-material-receipts" }
            },
            [
              _c(
                "button",
      ...
      _c("div", { staticClass: "title" }, [
        _vm._v(" New Return Material Receipt ")
      ])
    ]),
    _vm._v(" "),
    _vm.error
            ...
            _c("div", { staticClass: "col-md-5" }, [
              _c(
                ...
                _vm._l(_vm.contacts, function(contact) {
                  return _c(
                    "option",
                    { domProps: { value: contact.contact_id } },
          ...
          _c("table", { staticClass: "table table-bordered" }, [
            ...
            _c(
              ...
              [
                  ...
                  return _c("tr", { key: row }, [
                    ...
                    _c("td", [
                      _c(
                        ...
                        [
                          _c("option", { attrs: { value: "Good Stocks" } }, [
                            _vm._v(
                              "\n                                       Good Stocks\n                                    "
                            )
                          ]),
                    ...
                    _c("td", [
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("option", { attrs: { value: "NTE/Expired" } }, [
                            _vm._v("NTE/Expired")
                          ]),
                          _vm._v(" "),
                          ...
                          _vm._v(" "),
                          _c("option", { attrs: { value: "Contaminated" } }, [
                            _vm._v("Contaminated")
                          ]),
                          _vm._v(" "),
                          ...
                          _vm._v(" "),
                          _c("option", { attrs: { value: "Bloated/Busted" } }, [
                            _vm._v("Bloated/Busted")
                          ]),
                          _vm._v(" "),
                          _c("option", { attrs: { value: "Label Issue" } }, [
                            _vm._v("Label Issue")
                          ]),
                          _vm._v(" "),
                          _c(
                      ...
                      _c("input", {
                        ...
                        on: {
                          input: function($event) {
                            ...
                            _vm.$set(row, "return_price", $event.target.value)
                          }
                        }
                      })
                    ]),
                    ...
                    _c("td", [
                      _vm._v(
                        "\n                                " +
                          _vm._s(
                            Number(row.return_price * row.return_qty).toFixed(2)
                          ) +
                          "\n                            "
                      )
                    ]),
                ...
                _vm._v(" "),
                _vm._l(_vm.contactDiscounts, function(discount, index) {
                  return _c("tr", [
                    _c(
                      "td",
                ...
                _c("tr", [
                  ...
                  _c("td", [
                    _c("strong", [
                      _vm._v(
                        " " +
                          _vm._s(Number(_vm.total * 0.89285714285).toFixed(2)) +
                          " "
                      )
                    ])
                  ])
                ...
                _c("textarea", {
                  ...
                  on: {
                    input: function($event) {
                      ...
                      _vm.$set(_vm.newRMR, "return_notes", $event.target.value)
                    }
                  }
                })
              ])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-71e8b99c", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\components\\ReturnMaterialReceipt\\AddReturnMaterialReceipt.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-71e8b99c", Component.options)
  } else {
    hotAPI.reload("data-v-71e8b99c", Component.options)
  }
